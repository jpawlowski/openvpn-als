...
package net.openvpn.als.tunnels.agent;
...
import net.openvpn.als.tunnels.TunnelException;
...
public class DefaultRemoteTunnelManager implements RemoteTunnelManager {
     ...
     * (non-Javadoc)
     * 
     * @see net.openvpn.als.agent.remote.RemoteTunnelManager#init()
     */
    public void init() {
    }

    /* (non-Javadoc)
     * @see net.openvpn.als.tunnels.agent.RemoteTunnelManager#createRemoteTunnel(net.openvpn.als.tunnels.Tunnel, net.openvpn.als.agent.AgentTunnel, net.openvpn.als.policyframework.LaunchSession)
     */
     ...
     * (non-Javadoc)
     * 
     * @see net.openvpn.als.agent.remote.RemoteTunnelManager#getRemoteTunnels()
     */
     ...
     * (non-Javadoc)
     * 
     * @see net.openvpn.als.agent.remote.RemoteTunnelManager#stopRemoteTunnel(net.openvpn.als.agent.remote.RemoteTunnel)
     */
     ...
     * (non-Javadoc)
     * 
     * @see net.openvpn.als.agent.remote.RemoteTunnelManager#getRemoteTunnels(net.openvpn.als.security.SessionInfo)
     */
