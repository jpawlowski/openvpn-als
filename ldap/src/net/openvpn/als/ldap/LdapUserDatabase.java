...
import net.openvpn.als.util.ThreadRunner;
 ...
 * {@link net.openvpn.als.security.UserDatabase}.
 */
public class LdapUserDatabase extends DefaultUserDatabase implements CoreListener {
    ...
    */
     ...
     * (non-Javadoc)
     *
     * @see net.openvpn.als.security.UserDatabase#open(net.openvpn.als.core.CoreServlet, net.openvpn.als.realms.Realm)
     */
     ...
     * (non-Javadoc)
     *
     * @see net.openvpn.als.core.Database#close()
     */
    ...
    /**
     * Set the base DN (example : dc=openvpnals, dc=com)
     *
