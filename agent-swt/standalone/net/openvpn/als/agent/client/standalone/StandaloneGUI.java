...
import net.openvpn.als.agent.client.gui.swt.SWTAuthenticationDialog;
import net.openvpn.als.agent.client.gui.swt.SWTRunner;
import net.openvpn.als.agent.client.gui.swt.SWTSystemTrayGUI;
...
public class StandaloneGUI extends SWTSystemTrayGUI {
	...
	/* (non-Javadoc)
	 * @see net.openvpn.als.agent.client.gui.swt.SWTSystemTrayGUI#doInit()
	 */
	...
	/* (non-Javadoc)
	 * @see net.openvpn.als.agent.client.gui.swt.SWTSystemTrayGUI#exit()
	 */
	protected void exit() {
		super.exit();
	...
	/* (non-Javadoc)
	 * @see net.openvpn.als.agent.client.gui.swt.SWTSystemTrayGUI#promptForCredentials(boolean, com.maverick.http.HttpAuthenticator)
	 */
