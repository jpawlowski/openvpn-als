...
/**
 * Extension of a {@link com.adito.wizard.actions.AbstractWizardAction} 
 * that allows editing of the application shortcuts parameters that are 
 * supported for eact registered application extension.
 * 
 * @see com.adito.extensions.ApplicationLauncher
 * @see com.adito.extensions.ShortcutParameterItem
 */
public class ApplicationShortcutWizardAdditionalDetailsAction extends AbstractWizardAction {
     ...
     * Construtor
     */
    public ApplicationShortcutWizardAdditionalDetailsAction() {
        super();
    }
