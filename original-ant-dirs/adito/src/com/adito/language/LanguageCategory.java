 ...
 * /com/adito/agent/ApplicationResources.properties maps to the category
 * with the ID of <i>com.adito.agent</i>.
 * <p>
 ...
 * <p>
 * The location determines what component of Adito the 
...
public class LanguageCategory {
	 ...
	 */
	public final static String NAME_KEY = "adito.resourceBundle.name";
	
	/**
	 * The message key to use to retrieve the category description
	 */
	public final static String DESCRIPTION_KEY = "adito.resourceBundle.description";
	
	/**
	 * The message key to use to retrieve the category location
	 */
	public final static String LOCATION_KEY = "adito.resourceBundle.location";
	
    /**
     * The message key to use to retrieve the extension id
     */
    public final static String EXTENSION_ID_KEY = "adito.resourceBundle.extensionId";
     ...
     * namespace format. For example, <i>com.adito.agent</i>.
     * 
     * @return category ID
     */
    public String getId() {
     ...
     * an ID of com.adito.agent would have been found in
     * /com/adito/agent.
     * 
     * @return path
     */
     ...
     * adito-enterprise-core would have been found in
     * the core extension.
     * 
     * @return extensionId
     */
