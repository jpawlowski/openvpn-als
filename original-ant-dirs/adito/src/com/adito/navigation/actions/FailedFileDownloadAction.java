...
/**
 * <p>Action invoked when the user's download has expired.
 * 
 */

public class FailedFileDownloadAction extends DefaultAction {
    final static Log log = LogFactory.getLog(FailedFileDownloadAction.class);
