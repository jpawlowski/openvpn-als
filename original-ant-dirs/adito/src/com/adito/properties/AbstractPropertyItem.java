...
public abstract class AbstractPropertyItem implements Comparable<AbstractPropertyItem>, PropertyItem {
     ...
     * (non-Javadoc)
     * 
     * @see com.adito.properties.PropertyItem#getMessageResourcesKey()
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.adito.properties.PropertyItem#getColumns()
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.adito.properties.PropertyItem#getRows()
     */
    public int getRows() {
        return rows;
    }
     ...
     * (non-Javadoc)
     * 
     * @see com.adito.properties.PropertyItem#getDefinition()
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.adito.properties.PropertyItem#setDefinition(com.adito.boot.PropertyDefinition)
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.adito.properties.PropertyItem#getName()
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.adito.properties.PropertyItem#getCategory()
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.adito.properties.PropertyItem#getDefaultValue()
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.adito.properties.PropertyItem#getDefaultText()
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.adito.properties.PropertyItem#getTypeMeta()
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.adito.properties.PropertyItem#getListItems()
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.adito.properties.PropertyItem#getValue()
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.adito.properties.PropertyItem#getSelected()
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.adito.properties.PropertyItem#setSelected(boolean)
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.adito.properties.PropertyItem#setValue(java.lang.Object)
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.adito.properties.PropertyItem#getType()
     */
    public int getType() {
     ...
     * (non-Javadoc)
     * 
     * @see com.adito.properties.PropertyItem#getLabel()
     */
