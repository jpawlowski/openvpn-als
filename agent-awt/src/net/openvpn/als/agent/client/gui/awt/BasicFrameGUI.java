...
public class BasicFrameGUI extends AbstractAWTGUI {
    ...
    /* (non-Javadoc)
     * @see net.openvpn.als.agent.client.AgentClientGUI#init(net.openvpn.als.agent.client.Agent)
     */
    ...
    /* (non-Javadoc)
     * @see net.openvpn.als.agent.client.AgentClientGUI#addMenu(java.lang.String)
     */
	...
	/* (non-Javadoc)
	 * @see net.openvpn.als.agent.client.AgentClientGUI#removeMenu(java.lang.String)
	 */
	...
	/* (non-Javadoc)
	 * @see net.openvpn.als.agent.client.AgentClientGUI#clearMenu(java.lang.String)
	 */
	...
	/* (non-Javadoc)
	 * @see net.openvpn.als.agent.client.AgentClientGUI#isMenuExists(java.lang.String)
	 */
    ...
    /* (non-Javadoc)
     * @see net.openvpn.als.agent.client.AgentClientGUI#addMenuItem(java.lang.String, net.openvpn.als.agent.client.AgentAction)
     */
	...
	/* (non-Javadoc)
	 * @see net.openvpn.als.agent.client.gui.awt.AbstractAWTGUI#dispose()
	 */
	public void dispose() {
		frame.dispose();
		super.dispose();
	...
	/* (non-Javadoc)
	 * @see net.openvpn.als.agent.client.AgentClientGUI#addMenuSeperator(java.lang.String)
	 */
    ...
    /* (non-Javadoc)
     * @see net.openvpn.als.vpn.client.AbstractGUI#getGUIComponent()
     */
