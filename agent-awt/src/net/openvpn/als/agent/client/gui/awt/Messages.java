...
/**
 * Accesor class for message resources for the AWT Agent GUI implementation
 */
public class Messages {

    // Private statics
    private static ResourceBundle resourceBundle = ResourceBundle.getBundle("net.openvpn.als.agent.client.gui.awt.ApplicationResources"); //$NON-NLS-1$
