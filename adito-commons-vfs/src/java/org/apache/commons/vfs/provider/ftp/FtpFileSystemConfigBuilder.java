...
public class FtpFileSystemConfigBuilder extends FileSystemConfigBuilder
{
    ...
    private final static String IDLE_TIMEOUT = FtpFileSystemConfigBuilder.class.getName() + ".IDLE_TIMEOUT";
     ...
     * @see #setIdleTimeout
     */
    public Integer getIdleTimeout(FileSystemOptions opts)
    {
        return (Integer) getParam(opts, IDLE_TIMEOUT);
    }
    ...
    /**
     * set the idle timeout for the ftp client.<br />
     * If you set the idelTimeout to <code>null</code> no idleTimeout will be set on the
     * ftp client.
     *
     * @param opts
     * @param idelTimeout
     */
    public void setIdleTimeout(FileSystemOptions opts, Integer idleTimeout)
    {
        setParam(opts, IDLE_TIMEOUT, idleTimeout);
    }
}
