...
public class NetworkPlaceVFSResource extends FileObjectVFSResource {
    ...
    /* (non-Javadoc)
     * @see com.ovpnals.vfs.FileObjectVFSResource#delete()
     */
    ...
    /* (non-Javadoc)
     * @see com.ovpnals.vfs.FileObjectVFSResource#getChildren()
     */
	...
	/* (non-Javadoc)
	 * @see com.ovpnals.vfs.FileObjectVFSResource#getDisplayName()
	 */
	...
	/* (non-Javadoc)
	 * @see com.ovpnals.vfs.FileObjectVFSResource#isMount()
	 */
