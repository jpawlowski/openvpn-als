...
package com.ovpnals.networkplaces.store.jar;
...
public class JarStore extends AbstractNetworkPlaceStore {
    final static Log log = LogFactory.getLog(JarStore.class);
	/**
	 * Jar scheme name
	 */
    ...
    public JarStore(String storeName) {
