...
package com.ovpnals.networkplaces.store.zip;

import org.apache.commons.logging.Log;
import org.apache.commons.logging.LogFactory;

import com.ovpnals.networkplaces.DefaultArchiveMount;
...
public class ZipStore extends AbstractNetworkPlaceStore {
    final static Log log = LogFactory.getLog(ZipStore.class);
	/**
	 * Zip scheme name
	 */
    ...
    public ZipStore(String storeName) {
