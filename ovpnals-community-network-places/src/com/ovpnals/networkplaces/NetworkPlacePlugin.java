...
import  com.ovpnals.networkplaces.store.webdav.WebDAVProvider;
...
import com.ovpnals.networkplaces.forms.FileSystemForm;
import com.ovpnals.networkplaces.itemactions.FavoriteOpenWebFolderAction;
import com.ovpnals.networkplaces.itemactions.OpenWebFolderAction;
import com.ovpnals.networkplaces.store.cifs.CIFSProvider;
import com.ovpnals.networkplaces.store.cifs.CIFSStore;
import com.ovpnals.networkplaces.store.file.FileProvider;
import com.ovpnals.networkplaces.store.file.FileStore;
import com.ovpnals.networkplaces.store.ftp.FTPProvider;
import com.ovpnals.networkplaces.store.ftp.FTPStore;
import com.ovpnals.networkplaces.store.jar.JarProvider;
import com.ovpnals.networkplaces.store.jar.JarStore;
import com.ovpnals.networkplaces.store.tar.TarStore;
import com.ovpnals.networkplaces.store.webdav.WebDAVStore;
import com.ovpnals.networkplaces.store.zip.ZipProvider;
import com.ovpnals.networkplaces.store.zip.ZipStore;
import com.ovpnals.networkplaces.store.sftp.SFTPStore;
import com.ovpnals.networkplaces.store.sftp.SFTPProvider;
...
import com.ovpnals.vfs.VFSProviderManager;
import com.ovpnals.vfs.utils.UploadHandlerFactory;
...
public class NetworkPlacePlugin extends DefaultPlugin {
	 ...
	 * Extension bundle ID
	 */
	public static final String BUNDLE_ID = "ovpnals-community-network-places";
	...
	public NetworkPlacePlugin() {
		super("/WEB-INF/ovpnals-community-network-places-tiles-defs.xml", true);
	}
