...
<%@ page import="net.openvpn.als.core.PanelManager" %>
...
<%@ page import="net.openvpn.als.core.Panel" %>
					...
					<div id="layout_topbar">	
						<div id="component_pageHeader">	
			   				<div id="component_navigationBar">
								<ul>
									<logic:iterate id="rootMenuItem" name="navBar" type="net.openvpn.als.core.AvailableMenuItem">			
										<li>
