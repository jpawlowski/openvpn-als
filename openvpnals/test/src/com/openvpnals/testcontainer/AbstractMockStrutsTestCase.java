...
import net.openvpn.als.services.PolicyServiceImpl;
...
public abstract class AbstractMockStrutsTestCase extends MockStrutsTestCase {
    private static final String TEST_PROPERTY = "openvpnals.testing";
    private static final String DEV_CONFIG_PROPERTY = "openvpnals.useDevConfig";
    private static final String DEV_EXTENSIONS_PROPERTY = "openvpnals.devExtensions";
