...
import net.openvpn.als.core.stringreplacement.ExtensionBundleReplacer;
 ...
 * {@link #addOp(net.openvpn.als.extensions.ExtensionInstaller.ExtensionInstallOp)}.
...
public class ExtensionInstaller {
	...
	public static abstract class AbstractExtensionInstallOp implements ExtensionInstallOp {
		 ...
		 * (non-Javadoc)
		 * 
		 * @see net.openvpn.als.extensions.ExtensionInstaller.ExtensionInstallOp#getPhase()
		 */
		public String getPhase() {
			return phase;
		}
	...
	public static class MkdirInstallOp extends AbstractExtensionInstallOp {
		 ...
		 * (non-Javadoc)
		 * 
		 * @see net.openvpn.als.extensions.ExtensionInstaller.ExtensionInstallOp#doOp(net.openvpn.als.extensions.ExtensionInstaller)
		 */
		public void doOp(ExtensionInstaller install) throws Exception {
