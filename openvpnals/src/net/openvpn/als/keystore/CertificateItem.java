...
import net.openvpn.als.install.actions.InstallAction;
import net.openvpn.als.security.LogonController;
import net.openvpn.als.table.TableItem;

/**
 * A {@link net.openvpn.als.table.TableItem} implementation used by displaying
 * certificates or keys in a {@link net.openvpn.als.boot.KeyStoreManager}.
 */
