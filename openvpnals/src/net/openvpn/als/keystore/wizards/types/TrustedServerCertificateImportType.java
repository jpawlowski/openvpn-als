...
public class TrustedServerCertificateImportType extends AbstractKeyStoreImportType {
    ...
    /**
     * Constant for importing server certificates that OpenVPNALS should trust
     */
    ...
    /* (non-Javadoc)
     * @see net.openvpn.als.keystore.wizards.AbstractKeyStoreImportType#validate(org.apache.struts.action.ActionMessages, java.lang.String, java.lang.String, net.openvpn.als.wizard.AbstractWizardSequence, net.openvpn.als.security.SessionInfo)
     */
    ...
    /* (non-Javadoc)
     * @see net.openvpn.als.keystore.wizards.AbstractKeyStoreImportType#init(javax.servlet.http.HttpServletRequest)
     */
