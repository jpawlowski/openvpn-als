        ...
        if (wwwURLEncodedParameters) {
            ...
            for (Enumeration e = getParameterNames(); e.hasMoreElements(); ) {
                ...
                for (Iterator it2 = v.iterator(); it2.hasNext();) {
                    ...
                    encodedContent += (encodedContent.length() > 0 ? "&" : "") + Util.urlEncode(key, (charsetEncoding==null ? SystemProperties.get("openvpnals.urlencoding", "UTF-8") : charsetEncoding)) + "="
                    + Util.urlEncode(value, (charsetEncoding==null ? SystemProperties.get("openvpnals.urlencoding", "UTF-8") : charsetEncoding));
                }
            }
