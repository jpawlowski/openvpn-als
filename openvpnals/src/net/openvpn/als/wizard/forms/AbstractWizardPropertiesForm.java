...
public abstract class AbstractWizardPropertiesForm extends AbstractWizardForm implements PropertiesForm, TabModel {
     ...
     * (non-Javadoc)
     * 
     * @see net.openvpn.als.wizard.forms.AbstractWizardForm#reset(org.apache.struts.action.ActionMapping,
     ...
     * (non-Javadoc)
     * 
     * @see net.openvpn.als.properties.forms.PropertiesForm#getCategoryDefinitions()
     */
     ...
     * (non-Javadoc)
     * 
     * @see net.openvpn.als.properties.forms.PropertiesForm#getEnabled()
     */
     ...
     * (non-Javadoc)
     * 
     * @see net.openvpn.als.properties.forms.PropertiesForm#getParentCategory()
     */
     ...
     * (non-Javadoc)
     * 
     * @see net.openvpn.als.properties.forms.PropertiesForm#getPropertyItem(int)
     */
     ...
     * (non-Javadoc)
     * 
     * @see net.openvpn.als.properties.forms.PropertiesForm#getPropertyItems()
     */
     ...
     * (non-Javadoc)
     * 
     * @see net.openvpn.als.properties.forms.PropertiesForm#setCategoryDefinitions(java.util.List)
     */
     ...
     * (non-Javadoc)
     * 
     * @see net.openvpn.als.properties.forms.PropertiesForm#setPropertyItem(int,
     *      net.openvpn.als.applications.PropertyItem)
     */
     ...
     * (non-Javadoc)
     * 
     * @see net.openvpn.als.properties.forms.PropertiesForm#setPropertyItems(net.openvpn.als.applications.PropertyItem[])
     */
