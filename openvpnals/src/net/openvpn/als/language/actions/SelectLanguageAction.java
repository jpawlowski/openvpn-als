...
package net.openvpn.als.language.actions;
...
import net.openvpn.als.core.ErrorConstants;
...
public class SelectLanguageAction extends DefaultAction {
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response)
        ...
        Cookie cookie = new Cookie(SystemProperties.get("openvpnals.cookie", "SSLX_SSESHID") + "_LANG", locale.toString());
