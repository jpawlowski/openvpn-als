...
/**
 * Abstract implementation of an {@link net.openvpn.als.security.AuthenticationModule}
 * that simply checks the supplied authentication details against the information
 * in the current {@link net.openvpn.als.security.UserDatabase}.
 */
public abstract class AbstractPasswordAuthenticationModule implements AuthenticationModule {
     ...
     * (non-Javadoc)
     *
     * @see net.openvpn.als.security.AuthenticationModule#getName()
     */
    ...
    /* (non-Javadoc)
     * @see net.openvpn.als.security.AuthenticationModule#authenticate(javax.servlet.http.HttpServletRequest, net.openvpn.als.core.RequestParameterMap)
     */
     ...
     * (non-Javadoc)
     *
     * @see net.openvpn.als.security.AuthenticationModule#init(net.openvpn.als.security.AuthenticationSession)
     */
     ...
     * (non-Javadoc)
     *
     * @see net.openvpn.als.security.AuthenticationModule#isRequired()
     */
    ...
    /* (non-Javadoc)
     * @see net.openvpn.als.security.AuthenticationModule#authenticationComplete()
     */
