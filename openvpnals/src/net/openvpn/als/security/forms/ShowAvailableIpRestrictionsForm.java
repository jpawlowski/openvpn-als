...
import net.openvpn.als.security.IpRestrictionItem;
import net.openvpn.als.security.IpRestrictionItemModel;
import net.openvpn.als.table.forms.AbstractPagerForm;

/**
 * Implementation of a {@link net.openvpn.als.table.forms.AbstractPagerForm}
 * that allows an administrator to create and delete <i>IP Restrictions</i>.
 * 
 * @see net.openvpn.als.security.IpRestrictionItem
 */
public class ShowAvailableIpRestrictionsForm extends AbstractPagerForm {
    ...
    /* (non-Javadoc)
     * @see net.openvpn.als.table.forms.AbstractPagerForm#reset(org.apache.struts.action.ActionMapping, javax.servlet.http.HttpServletRequest)
     */
