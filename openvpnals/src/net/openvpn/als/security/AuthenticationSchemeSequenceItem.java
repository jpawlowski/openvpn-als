...
/**
 * Implementation of a {@link net.openvpn.als.table.TableItem} that is used to
 * wrap {@link net.openvpn.als.security.AuthenticationScheme} objects for
 * display. 
 */
public class AuthenticationSchemeSequenceItem extends ResourceItem<AuthenticationScheme> {
    ...
    /* (non-Javadoc)
     * @see net.openvpn.als.policyframework.ResourceItem#getSmallIconPath(javax.servlet.http.HttpServletRequest)
     */
