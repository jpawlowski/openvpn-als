 ...
 * be able to logon on use OpenVPNALS's services.
 * <p>
 * Each module must have an {@link net.openvpn.als.security.AuthenticationModuleDefinition}
 * that must be registed with the {@link net.openvpn.als.security.AuthenticationModuleManager}.
 * <p>
 ...
 * method will be called expecting either a {@link net.openvpn.als.security.Credentials}
 ...
 * used interally by the OpenVPNALS or its plugins but never presented to
 * user directly. These are currently used for Webdav and Embedded client
 * logons. 
 * 
 * @see net.openvpn.als.security.AuthenticationScheme
 * @see net.openvpn.als.security.AuthenticationModuleDefinition
 * @see net.openvpn.als.security.AuthenticationModuleManager
 */
