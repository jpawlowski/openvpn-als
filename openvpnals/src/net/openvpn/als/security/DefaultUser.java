...
/**
 * Implementation of a {@link net.openvpn.als.security.User}
...
public class DefaultUser implements User, Serializable {
    ...
    /*
     * (non-Javadoc)
     * @see net.openvpn.als.security.User#getLastPasswordChange()
     */
    ...
    /*
     * (non-Javadoc)
     * @see net.openvpn.als.permissions.Principal#getPrincipalName()
     */
    ...
    /*
     * (non-Javadoc)
     * @see net.openvpn.als.security.User#getEmail()
     */
    ...
    /*
     * (non-Javadoc)
     * @see net.openvpn.als.security.User#getFullname()
     */
    ...
    /*
     * (non-Javadoc)
     * @see net.openvpn.als.security.User#getHomeNetworkPlaceUri()
     */
    ...
    /*
     * (non-Javadoc)
     * @see net.openvpn.als.security.User#getRoles()
     */
