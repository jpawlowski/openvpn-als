...
import net.openvpn.als.navigation.actions.RedirectAction;
...
import net.openvpn.als.vfs.UploadManager;

/**
 * Strings contants used throughout OpenVPN-ALS.
 *
...
public class Constants {
     ...
     */
    public final static String GLOBAL_WARNINGS_KEY = "net.openvpn.als.GLOBAL_WARNINGS";

    /**
     * Comment for <code>BUNDLE_MESSAGES_KEY</code>
     */
    public final static String BUNDLE_MESSAGES_KEY = "net.openvpn.als.BUNDLE_MESSAGES";

    /**
     * Comment for <code>BUNDLE_ERRORS_KEY</code>
     */
    public final static String BUNDLE_ERRORS_KEY = "net.openvpn.als.BUNDLE_ERRORS";
     ...
     */
    public static final String ATTR_CACHE = "openvpnals.cache";

    /**
     * Comment for <code>ATTR_COOKIE_MAP</code>
     */
    public static final String ATTR_COOKIE_MAP = "openvpnals.cookieMap";
    ...
    /**
     * Key used to access {@link net.openvpn.als.vfs.clipboard.Clipboard} 
    ...
    /**
     * {@link net.openvpn.als.navigation.actions.HelpAction} stores this 
     * attribute in the request. It contains the {@link net.openvpn.als.boot.PropertyDefinition}
     * that help has been requsted for.
     */
    public static final String REQ_ATTR_PROPERTY_DEFINITION = "propertyDefinition";

    /**
     * Contains the current {@link net.openvpn.als.vfs.UploadDetails}  to be
     * passed on to {@link net.openvpn.als.vfs.actions.ShowUploadAction}.
     */
