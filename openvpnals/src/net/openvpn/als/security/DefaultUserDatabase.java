...
/**
 * Default implementation of a {@link net.openvpn.als.security.UserDatabase}.
 */
public abstract class DefaultUserDatabase implements UserDatabase {
    ...
    /*
     * (non-Javadoc)
     * @see net.openvpn.als.security.UserDatabase#supportsPasswordChange()
     */
    ...
    /*
     * (non-Javadoc)
     * @see net.openvpn.als.security.UserDatabase#supportsAccountCreation()
     */
    ...
    /*
     * (non-Javadoc)
     * @see net.openvpn.als.security.UserDatabase#getDatabaseDescription()
     */
    ...
    /*
     * (non-Javadoc)
     * @see net.openvpn.als.security.UserDatabase#changePassword(java.lang.String, java.lang.String, java.lang.String, boolean)
     */
    ...
    /*
     * (non-Javadoc)
     * @see net.openvpn.als.security.UserDatabase#setPassword(java.lang.String, java.lang.String, boolean, net.openvpn.als.security.User, java.lang.String)
     */
    ...
    /*
     * (non-Javadoc)
     * @see net.openvpn.als.security.UserDatabase#createAccount(java.lang.String, java.lang.String, java.lang.String, java.lang.String net.openvpn.als.security.Role[])
     */
    ...
    /*
     * (non-Javadoc)
     * @see net.openvpn.als.security.UserDatabase#updateAccount(net.openvpn.als.security.User, java.lang.String, java.lang.String, net.openvpn.als.security.Role[])
     */
    ...
    /*
     * (non-Javadoc)
     * @see net.openvpn.als.security.UserDatabase#deleteAccount(net.openvpn.als.security.User)
     */
    ...
    /*
     * (non-Javadoc)
     * @see net.openvpn.als.security.UserDatabase#createRole(java.lang.String)
     */
    ...
    /*
     * (non-Javadoc)
     * @see net.openvpn.als.security.UserDatabase#deleteRole(java.lang.String)
     */
    ...
    /*
     * (non-Javadoc)
     * @see net.openvpn.als.core.Database#cleanup()
     */
    ...
    /*
     * (non-Javadoc)
     * @see net.openvpn.als.security.UserDatabase#getRealm()
     */
    ...
    /*
     * (non-Javadoc)
     * @see net.openvpn.als.security.UserDatabase#close()
     */
    ...
    /*
     * (non-Javadoc)
     * @see net.openvpn.als.security.UserDatabase#isOpen()
     */
