...
/**
 * 
 * Generic action to be used for all authenticated actions by the OpenVPNALS
 ...
 * request path.
 * @since 0.1
 * @see net.openvpn.als.core.actions.AuthenticatedDispatchAction
 */
