...
public class CoreMenuTree extends MenuTree {
    ...
    public CoreMenuTree() {
        ...
        addMenuItem("help", new MenuItem("referenceGuidePDF", "navigation", "http://localhost/products/openvpnals/documentation/OpenVPN-ALS_Administrators_Guide.pdf", 300, true, "_blank", SessionInfo.HELP_CONTEXT));
        
        addMenuItem("help", new MenuItem("referenceGuideHTML", "navigation", "http://localhost/products/openvpnals/documentation/html/w2wfrm.htm", 300, true, "_blank", SessionInfo.HELP_CONTEXT));
        
        // Documentation
        addMenuItem("help", new MenuItem("knowledgeBase", "navigation", "http://localhost/kb", 400, true, "_blank",
            SessionInfo.HELP_CONTEXT));

        addMenuItem("help", new MenuItem("support", "navigation", "http://localhost/showOpenVPN-ALS.do", 500, true, "_blank", SessionInfo.HELP_CONTEXT));
