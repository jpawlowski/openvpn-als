...
/**
 * Abstract implementation of a {@link net.openvpn.als.core.Panel}.
 */
public abstract class AbstractPanel implements Panel {
    ...
    /* (non-Javadoc)
     * @see net.openvpn.als.core.Panel#isDropable()
     */
    ...
    /* (non-Javadoc)
     * @see net.openvpn.als.core.Panel#isDragable()
     */
    ...
    /* (non-Javadoc)
     * @see net.openvpn.als.core.Panel#getPlacement()
     */
    ...
    /* (non-Javadoc)
     * @see net.openvpn.als.core.Panel#getWeight()
     */
    ...
    /* (non-Javadoc)
     * @see net.openvpn.als.core.Panel#getId()
     */
    public String getId() {
        return id;
    }
    ...
    /* (non-Javadoc)
     * @see net.openvpn.als.core.Panel#getBundle()
     */
    ...
    /* (non-Javadoc)
     * @see net.openvpn.als.core.Panel#getTileIncludePath(javax.servlet.jsp.PageContext)
     */
    ...
    /* (non-Javadoc)
     * @see net.openvpn.als.core.Panel#isCloseable()
     */
    ...
    /* (non-Javadoc)
     * @see net.openvpn.als.core.Panel#getDefaultFrameState()
     */
	...
	/* (non-Javadoc)
	 * @see net.openvpn.als.core.Panel#setDragable(boolean)
	 */
	...
	/* (non-Javadoc)
	 * @see net.openvpn.als.core.Panel#setDropable(boolean)
	 */
    ...
    /* (non-Javadoc)
     * @see net.openvpn.als.core.Panel#isMinimizable()
     */
	...
	/* (non-Javadoc)
	 * @see net.openvpn.als.core.Panel#setMinimizable(boolean)
	 */
