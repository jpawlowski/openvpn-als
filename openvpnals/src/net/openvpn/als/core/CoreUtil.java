...
import net.openvpn.als.core.actions.CoreAction;
import net.openvpn.als.core.actions.LicenseAgreementDispatchAction;
...
import net.openvpn.als.vfs.store.downloads.TempStore;
...
public class CoreUtil {
    ...
    public static void updateEventsTable(String bundle, Class clazz) {
        Plugin auditingPlugin = PluginType.getPlugin("openvpnals-enterprise-auditing");
