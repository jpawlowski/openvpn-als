 ...
 * whole of OpenVPNALS and all of its plugins.</li>
 ...
 * {@link net.openvpn.als.core.CoreEventConstants#USER_CREATED} would also add
 * an attribute with the key 
 * {@link net.openvpn.als.core.CoreAttributeConstants#EVENT_ATTR_PRINCIPAL_ID}
 * and a value of the username being created.
 * <p>
 * All events also have a time attribute that is set when the object is 
 * instantiated.  
 * 
 * @see net.openvpn.als.core.CoreListener
 * @see net.openvpn.als.core.CoreServlet
 * @see net.openvpn.als.core.CoreEventConstants
 * @see net.openvpn.als.core.CoreAttributeConstants
 */
