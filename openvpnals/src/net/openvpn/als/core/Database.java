...
/**
 * OpenVPNALS stores most of its configuration and resources in one of
 * the <i>Database</i> implementations.
 * <p>
 * Current databases include {@link net.openvpn.als.properties.PropertyDatabase},
 * {@link net.openvpn.als.security.SystemDatabase} and 
 * {@link net.openvpn.als.policyframework.PolicyDatabase}.
...
public interface Database {
     ...
     * relevant.
     * <p>
     * For example, OpenVPNALS allows the administrator to select the
     * source of <i>User Accounts</i>. The administrator chooses to use
     * the <i>Active Directory User Database</i>. Because OpenVPNALS does
