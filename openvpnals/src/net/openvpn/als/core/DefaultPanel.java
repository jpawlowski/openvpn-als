...
/**
 * Default implementation of an {@link net.openvpn.als.core.AbstractPanel}
...
public class DefaultPanel extends AbstractPanel {
    ...
    /* (non-Javadoc)
     * @see net.openvpn.als.core.Panel#isAvailable(javax.servlet.http.HttpServletRequest, javax.servlet.http.HttpServletResponse)
     */
