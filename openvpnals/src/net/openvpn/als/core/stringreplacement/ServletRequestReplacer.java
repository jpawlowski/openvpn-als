	...
	public String processReplacementVariable(Pattern pattern, Matcher matcher,
		...
		if (type.equalsIgnoreCase("request")) {
			if (request == null) {
				...
				return request.isSecure() ? String.valueOf(request.getServerPort()) : SystemProperties.get("jetty.force.HTTPSRedirect", "false").equals("true") ? SystemProperties.get("openvpnals.fakeHTTPSPort", "443") : String.valueOf(request.getServerPort());
