...
public interface Favorite {
     ...
     * id ({@link net.openvpn.als.policyframework.ResourceType#getResourceTypeId()})
     * of the {@link net.openvpn.als.policyframework.Resource} the favorite
     * points to.
     * 
    ...
    /**
     * Get the ID of the {@link net.openvpn.als.policyframework.Resource} that
