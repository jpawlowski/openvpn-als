...
/**
 * Default implementation of a {@link net.openvpn.als.navigation.Favorite}.
 * 
...
public class DefaultFavorite implements Favorite {
     ...
     * (non-Javadoc)
     * 
     * @see net.openvpn.als.navigation.Favorite#getId()
     */
    public int getId() {
        return id;
    }
     ...
     * (non-Javadoc)
     * 
     * @see net.openvpn.als.navigation.Favorite#getUsername()
     */
     ...
     * (non-Javadoc)
     * 
     * @see net.openvpn.als.navigation.Favorite#getType()
     */
    public int getType() {
        return type;
    }
     ...
     * (non-Javadoc)
     * 
     * @see net.openvpn.als.navigation.Favorite#getFavoriteKey()
     */
