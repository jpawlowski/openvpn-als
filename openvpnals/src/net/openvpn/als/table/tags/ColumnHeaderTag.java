...
package net.openvpn.als.table.tags;
...
import net.openvpn.als.core.tags.FormTag;
import net.openvpn.als.table.Pager;

public class ColumnHeaderTag extends LinkTag {

    /**
     * Name of the bean that contains the {@link net.openvpn.als.table.Pager}
     * object
     */
     ...
     * the {@link net.openvpn.als.table.Pager}.
     */
