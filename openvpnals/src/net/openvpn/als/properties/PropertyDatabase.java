...
/**
 * <p>
 * Property databases are a core component of OpenVPNALS and are used to store 
 ...
 * each unique <i>id</i> there must have been a single {@link net.openvpn.als.boot.PropertyDefinition}
 ...
 * its category ID and other information. See {@link net.openvpn.als.boot.PropertyDefinition}
 ...
 *  <p>
 *  Only property definitions that have a visibility of {@link net.openvpn.als.boot.PropertyDefinition#PROFILE}
 ...
 *  
 *  Properties that are only used for configuring the {@link net.openvpn.als.boot.Context}
 *  implementation in use. Properties of this type are different in that their
 *  values are stored and retrieved using {@link net.openvpn.als.boot.Context#setContextProperty(String, String)}
 *  and {@link net.openvpn.als.boot.Context#getContextProperty(String)}. The 
 *  property definition objects are retrieve using {@link net.openvpn.als.boot.Context#getContextPropertyDefinitions()}
 ...
 *  {@link net.openvpn.als.boot.PropertyDefinition#SYSTEM_CONFIGURATION}
 *  
 ...
 *  {@link net.openvpn.als.boot.PropertyDefinition#isHidden()} is called.
 */
...
public interface PropertyDatabase extends Database {
     ...
     * use methods in {@link net.openvpn.als.properties.Property}.
     * 
     * @param key1 key 1
     * @param key2 key 2
     * @param key3 key 3
