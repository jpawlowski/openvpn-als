 ...
 * {@link net.openvpn.als.boot.PropertyDefinition#PROFILE} may exist in global
 ...
 * {@link net.openvpn.als.policyframework.Resource} so is subject ot all
 * the rules imposed on by the <i>Policy Framework</i>. In fact it is a
 * specialised type of resource known as a
 * {@link net.openvpn.als.policyframework.OwnedResource}. *
 */
