...
/**
 * Default implementation of a {@link net.openvpn.als.properties.PropertyProfile}.
 */
public class DefaultPropertyProfile extends AbstractResource implements PropertyProfile {
    ...
    /* (non-Javadoc)
     * @see net.openvpn.als.boot.PropertyProfile#getLabel()
     */
    ...
    /* (non-Javadoc)
     * @see net.openvpn.als.boot.policyframework.OwnedResource#getOwnerUsername()
     */
    ...
    /* (non-Javadoc)
     * @see net.openvpn.als.policyframework.AbstractResource#compareTo(java.lang.Object)
     */
