...
public abstract class AbstractPropertyItem implements Comparable<AbstractPropertyItem>, PropertyItem {
     ...
     * (non-Javadoc)
     * 
     * @see net.openvpn.als.properties.PropertyItem#getMessageResourcesKey()
     */
     ...
     * (non-Javadoc)
     * 
     * @see net.openvpn.als.properties.PropertyItem#getColumns()
     */
     ...
     * (non-Javadoc)
     * 
     * @see net.openvpn.als.properties.PropertyItem#getRows()
     */
    public int getRows() {
        return rows;
    }
     ...
     * (non-Javadoc)
     * 
     * @see net.openvpn.als.properties.PropertyItem#getDefinition()
     */
     ...
     * (non-Javadoc)
     * 
     * @see net.openvpn.als.properties.PropertyItem#setDefinition(net.openvpn.als.boot.PropertyDefinition)
     */
     ...
     * (non-Javadoc)
     * 
     * @see net.openvpn.als.properties.PropertyItem#getName()
     */
     ...
     * (non-Javadoc)
     * 
     * @see net.openvpn.als.properties.PropertyItem#getCategory()
     */
     ...
     * (non-Javadoc)
     * 
     * @see net.openvpn.als.properties.PropertyItem#getDefaultValue()
     */
     ...
     * (non-Javadoc)
     * 
     * @see net.openvpn.als.properties.PropertyItem#getDefaultText()
     */
     ...
     * (non-Javadoc)
     * 
     * @see net.openvpn.als.properties.PropertyItem#getTypeMeta()
     */
     ...
     * (non-Javadoc)
     * 
     * @see net.openvpn.als.properties.PropertyItem#getListItems()
     */
     ...
     * (non-Javadoc)
     * 
     * @see net.openvpn.als.properties.PropertyItem#getValue()
     */
     ...
     * (non-Javadoc)
     * 
     * @see net.openvpn.als.properties.PropertyItem#getSelected()
     */
     ...
     * (non-Javadoc)
     * 
     * @see net.openvpn.als.properties.PropertyItem#setSelected(boolean)
     */
     ...
     * (non-Javadoc)
     * 
     * @see net.openvpn.als.properties.PropertyItem#setValue(java.lang.Object)
     */
     ...
     * (non-Javadoc)
     * 
     * @see net.openvpn.als.properties.PropertyItem#getType()
     */
    public int getType() {
     ...
     * (non-Javadoc)
     * 
     * @see net.openvpn.als.properties.PropertyItem#getPropertyValue()
     */
     ...
     * (non-Javadoc)
     * 
     * @see net.openvpn.als.properties.PropertyItem#getLabel()
     */
