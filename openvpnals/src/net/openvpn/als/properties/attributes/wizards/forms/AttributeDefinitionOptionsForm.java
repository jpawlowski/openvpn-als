...
package net.openvpn.als.properties.attributes.wizards.forms;
...
import net.openvpn.als.properties.attributes.wizards.actions.AttributeDefinitionDetailsAction;
import net.openvpn.als.properties.attributes.wizards.actions.AttributeDefinitionOptionsAction;
...
public class AttributeDefinitionOptionsForm extends DefaultWizardForm {
    ...
    public void init(AbstractWizardSequence sequence, HttpServletRequest request) throws Exception {
        ...
        validationString  = (String)sequence.getAttribute(AttributeDefinitionOptionsAction.ATTR_VALIDATION_STRING, "net.openvpn.als.input.validators.StringValidator(minLength=0,maxLength=30,trim=true,regExp=,pattern=)");
