...
public abstract class AbstractVFSProvider implements VFSProvider {
	...
	/* (non-Javadoc)
	 * @see net.openvpn.als.vfs.VFSProvider#getBundle()
	 */
	...
	/* (non-Javadoc)
	 * @see net.openvpn.als.vfs.VFSProvider#getScheme()
	 */
	...
	/* (non-Javadoc)
	 * @see net.openvpn.als.vfs.VFSProvider#getStoreClass()
	 */
	...
	/* (non-Javadoc)
	 * @see net.openvpn.als.vfs.VFSProvider#isFireEvents()
	 */
	...
	/* (non-Javadoc)
	 * @see net.openvpn.als.vfs.VFSProvider#isHiddenFilesSupported()
	 */
	...
	/* (non-Javadoc)
	 * @see net.openvpn.als.vfs.VFSProvider#isRequiredHost()
	 */
	...
	/* (non-Javadoc)
	 * @see net.openvpn.als.vfs.VFSProvider#isRequiredPort()
	 */
	...
	/* (non-Javadoc)
	 * @see net.openvpn.als.vfs.VFSProvider#isRequiredUserInfo()
	 */
	...
	/* (non-Javadoc)
	 * @see net.openvpn.als.vfs.VFSProvider#willHandle(java.lang.String)
	 */
	...
	/* (non-Javadoc)
	 * @see net.openvpn.als.vfs.VFSProvider#getPathRequirement()
	 */
