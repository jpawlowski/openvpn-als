    	...
    	try {
	        ...
	        try {
	            if (resource.isCollection() || resource.isMount()) {
	            	...
	            	if(SystemProperties.get("openvpnals.disableFolderBrowsing", "true").equals("true") && !resource.isBrowsable()) {
	                ...
	                if (parent != null && (parent.isBrowsable() || !SystemProperties.get("openvpnals.disableFolderBrowsing", "true").equals("true"))) {
		                out.println("<tr>");
