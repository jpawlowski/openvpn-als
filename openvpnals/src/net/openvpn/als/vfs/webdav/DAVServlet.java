 ...
 * OpenVPN-ALS has developed, much of the original code has been replaced.
 * <p>
 * The servlet is now fully integrated into OpenVPN-ALS and its <i>Virtual File
...
public class DAVServlet implements Servlet, DAVListener {
    ...
    public void service(ServletRequest request, ServletResponse response) throws ServletException, IOException {
        ...
        try {
             ...
             * is in a mount that does not require OpenVPN-ALS authentication
            ...
            // We need to be able to authenticate the OpenVPN-ALS session was
            // well
    ...
    private void debugRequest(HttpServletRequest req) {
        if (SystemProperties.get("openvpnals.webdav.debug", "false").equalsIgnoreCase("true")) {
    ...
    public static void sendAuthorizationError(HttpServletRequest request, HttpServletResponse response, String realm)
                    throws IOException {
        /*
         * If this is for the default realm (i.e OpenVPN-ALS Authentication, we
