...
public abstract class AbstractStore implements VFSStore {
	...
	/* (non-Javadoc)
	 * @see net.openvpn.als.vfs.VFSStore#getMountPath(java.lang.String)
	 */
    ...
    /* (non-Javadoc)
     * @see net.openvpn.als.vfs.VFSStore#getEncoding()
     */
    ...
    /* (non-Javadoc)
     * @see net.openvpn.als.vfs.VFSStore#getName()
     */
    ...
    /* (non-Javadoc)
     * @see net.openvpn.als.vfs.VFSStore#getGuestUsername()
     */
    ...
    /* (non-Javadoc)
     * @see net.openvpn.als.vfs.VFSStore#getGuestPassword()
     */
    ...
    /* (non-Javadoc)
     * @see net.openvpn.als.vfs.VFSStore#init(net.openvpn.als.vfs.VFSRepository, net.openvpn.als.vfs.VFSProvider)
     */
    ...
    /* (non-Javadoc)
     * @see net.openvpn.als.vfs.VFSStore#getProvider()
     */
    ...
    /* (non-Javadoc)
     * @see net.openvpn.als.vfs.VFSStore#getRepository()
     */
    ...
    /* (non-Javadoc)
     * @see net.openvpn.als.vfs.VFSStore#getStoreResource()
     */
