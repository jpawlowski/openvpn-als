...
public abstract class AbstractVFSMount implements VFSMount {
	...
	private boolean requiresOpenVPNALSAuthentication;
	 ...
	 * (non-Javadoc)
	 * 
	 * @see net.openvpn.als.vfs.webdav.DAVMount#getStore()
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see net.openvpn.als.vfs.webdav.DAVMount#getResource(java.lang.String,
	 *      net.openvpn.als.vfs.webdav.DAVTransaction)
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see net.openvpn.als.vfs.webdav.DAVMount#getMountString()
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see net.openvpn.als.vfs.VFSMount#resourceCopy(net.openvpn.als.vfs.VFSResource,
	 *      net.openvpn.als.vfs.VFSResource,
	 *      net.openvpn.als.vfs.webdav.DAVTransaction, java.lang.Throwable)
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see net.openvpn.als.vfs.VFSMount#resourceDelete(net.openvpn.als.vfs.VFSResource,
	 *      net.openvpn.als.vfs.webdav.DAVTransaction, java.lang.Throwable)
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see net.openvpn.als.vfs.VFSMount#resourceUpload(net.openvpn.als.vfs.VFSResource,
	 *      net.openvpn.als.vfs.webdav.DAVTransaction, java.lang.Throwable)
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see net.openvpn.als.vfs.VFSMount#resourceAccessList(net.openvpn.als.vfs.VFSResource,
	 *      net.openvpn.als.vfs.webdav.DAVTransaction, java.lang.Throwable)
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see net.openvpn.als.vfs.VFSMount#resourceCollectionCreated(net.openvpn.als.vfs.VFSResource,
	 *      net.openvpn.als.vfs.webdav.DAVTransaction, java.lang.Throwable)
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see net.openvpn.als.vfs.VFSMount#resourceMoved(net.openvpn.als.vfs.VFSResource,
	 *      net.openvpn.als.vfs.VFSResource,
	 *      net.openvpn.als.vfs.webdav.DAVTransaction, java.lang.Throwable)
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see net.openvpn.als.vfs.VFSMount#resourceAccessDownloading(net.openvpn.als.vfs.VFSResource,
	 *      net.openvpn.als.vfs.webdav.DAVTransaction)
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see net.openvpn.als.vfs.VFSMount#resourceAccessDownloadComplete(net.openvpn.als.vfs.VFSResource,
	 *      net.openvpn.als.vfs.webdav.DAVTransaction, java.lang.Throwable)
	 */
    ...
    /* (non-Javadoc)
     * @see net.openvpn.als.vfs.VFSMount#isRequiresOpenVPNALSAuthentication()
     */
    public boolean isRequiresOpenVPNALSAuthentication() {
        return requiresOpenVPNALSAuthentication;
    }

    /**
     * Set whether this mount requires OpenVPNALS authentication.
     * 
     * @param requiresOpenVPNALSAuthentication requires OpenVPNALS authentication
     */
    public void setRequiresOpenVPNALSAuthentication(boolean requiresOpenVPNALSAuthentication) {
        this.requiresOpenVPNALSAuthentication = requiresOpenVPNALSAuthentication;
    }
