...
/**
 * Every {@link net.openvpn.als.policyframework.AccessRights} defined
 * by the super user or delegated administrator has attached to it a 
 * list of {@link net.openvpn.als.policyframework.AccessRight}
 ...
 * 
 * @author Brett Smith
 * @see net.openvpn.als.policyframework.PolicyConstants for a list of standard permissions
 */
