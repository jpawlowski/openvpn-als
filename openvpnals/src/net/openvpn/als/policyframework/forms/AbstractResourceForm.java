...
/**
 * Abstract implementation of {@link net.openvpn.als.core.forms.CoreForm} that
 * allows editing of {@link net.openvpn.als.policyframework.Resource} instances.
 * 
...
public abstract class AbstractResourceForm<T extends Resource> extends CoreForm implements TabModel {
    ...
    /**
     * If this is an {@link net.openvpn.als.policyframework.OwnedResource}
    ...
    /* (non-Javadoc)
     * @see net.openvpn.als.core.forms.CoreForm#reset(org.apache.struts.action.ActionMapping, javax.servlet.http.HttpServletRequest)
     */
    @Override
