...
/**
 * Implementation of a
 * {@link net.openvpn.als.policyframework.forms.AbstractResourcesForm} which
 * contains a model of {@link net.openvpn.als.policyframework.AccessRightsItem}
 * instances.
 */
public class AccessRightsListForm extends AbstractResourcesForm<AccessRightsItem> {
    ...
    /**
     * Implementation of a
     * {@link net.openvpn.als.policyframework.ResourceItemModel} which is a
     * model of {@link net.openvpn.als.policyframework.AccessRightsItem}
     * instances.
     */
    static class AccessRightsModel extends ResourceItemModel<AccessRightsItem> {
         ...
         * (non-Javadoc)
         * 
         * @see net.openvpn.als.policyframework.ResourceItemModel#getColumnCount()
         */
         ...
         * (non-Javadoc)
         * 
         * @see net.openvpn.als.policyframework.ResourceItemModel#getColumnName(int)
         */
