...
/**
 * Default implementation of an {@link net.openvpn.als.policyframework.AccessRights}
 */
public class DefaultAccessRights extends AbstractResource implements AccessRights {
    ...
    /* (non-Javadoc)
     * @see net.openvpn.als.policyframework.AccessRights#addAccessRight(net.openvpn.als.policyframework.AccessRight)
     */
    ...
    /* (non-Javadoc)
     * @see net.openvpn.als.policyframework.AccessRights#removeAccessRight(net.openvpn.als.policyframework.AccessRight)
     */
    ...
    /* (non-Javadoc)
     * @see net.openvpn.als.policyframework.AccessRights#getAccessRights()
     */
    ...
    /* (non-Javadoc)
     * @see net.openvpn.als.policyframework.AccessRights#getRules()
     */
    ...
    /* (non-Javadoc)
     * @see net.openvpn.als.policyframework.AccessRights#addRule(net.openvpn.als.policyframework.Rule)
     */
    ...
    /* (non-Javadoc)
     * @see net.openvpn.als.policyframework.AccessRights#setAllAccessRights(javax.servlet.http.HttpSession, net.openvpn.als.boot.PropertyList)
     */
