...
import net.openvpn.als.properties.impl.resource.ResourceKey;
...
public abstract class AbstractResource implements Resource, Serializable {
     ...
     * (non-Javadoc)
     * 
     * @see net.openvpn.als.boot.policyframework.Resource#getResourceId()
     */
     ...
     * (non-Javadoc)
     * 
     * @see net.openvpn.als.boot.policyframework.Resource#getResourceType()
     */
     ...
     * (non-Javadoc)
     * 
     * @see net.openvpn.als.boot.policyframework.Resource#getResourceName()
     */
     ...
     * (non-Javadoc)
     * 
     * @see net.openvpn.als.boot.policyframework.Resource#getResourceDisplayName()
     */
     ...
     * (non-Javadoc)
     * 
     * @see net.openvpn.als.boot.policyframework.Resource#getResourceDescription()
     */
     ...
     * (non-Javadoc)
     * 
     * @see net.openvpn.als.boot.policyframework.Resource#setResourceName(java.lang.String)
     */
     ...
     * (non-Javadoc)
     * 
     * @see net.openvpn.als.boot.policyframework.Resource#setResourceDescription(java.lang.String)
     */
     ...
     * (non-Javadoc)
     * 
     * @see net.openvpn.als.boot.policyframework.Resource#getDateCreated()
     */
     ...
     * (non-Javadoc)
     * 
     * @see net.openvpn.als.boot.policyframework.Resource#getDateAmended()
     */
     ...
     * (non-Javadoc)
     * 
     * @see net.openvpn.als.boot.policyframework.Resource#setDateAmended(java.util.Calendar)
     */
     ...
     * (non-Javadoc)
     * 
     * @see net.openvpn.als.policyframework.Resource#requiresPassword()
     */
     ...
     * (non-Javadoc)
     * 
     * @see net.openvpn.als.policyframework.Resource#paramsRequirePassword()
     */
     ...
     * (non-Javadoc)
     * 
     * @see net.openvpn.als.policyframework.Resource#getRealmID()
     */
     ...
     * (non-Javadoc)
     * 
     * @see net.openvpn.als.policyframework.ResourceType#getLaunchRequirement()
     */
