...
import net.openvpn.als.extensions.actions.AbstractLaunchViaAppletAction;
...
public class LaunchAgentAction extends AbstractLaunchViaAppletAction {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see net.openvpn.als.extensions.actions.AbstractLaunchViaAppletAction#getExtensionDescriptor(org.apache.struts.action.ActionMapping,
