...
import net.openvpn.als.boot.RequestHandlerTunnel;
...
public class AgentTunnel extends MultiplexedConnection implements
	...
	/* (non-Javadoc)
	 * @see net.openvpn.als.boot.RequestHandlerTunnel#tunnel(java.io.InputStream, java.io.OutputStream)
	 */
	...
	public boolean isAlive(MultiplexedConnection con) {
		...
		/* In the context of OpenVPNALS returning true here is OK as timeouts
