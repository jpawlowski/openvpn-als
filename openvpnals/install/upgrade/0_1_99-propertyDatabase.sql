...
CREATE ALIAS PASSWORD FOR 'net.openvpn.als.jdbc.hsqldb.DBFunctions.password';
CREATE ALIAS ENCODE FOR 'net.openvpn.als.jdbc.hsqldb.DBFunctions.encode';
CREATE ALIAS DECODE FOR 'net.openvpn.als.jdbc.hsqldb.DBFunctions.decode';
CREATE ALIAS ENCPASSWORD FOR 'net.openvpn.als.jdbc.hsqldb.DBFunctions.encPassword';
CREATE ALIAS MATCHES FOR 'net.openvpn.als.jdbc.hsqldb.DBFunctions.matches';
...
INSERT INTO EXPLORER_PROPERTY_DEFINITION (NAME,VISIBILITY,TYPE,SORT_ORDER,TYPE_META,CATEGORY,DEFAULT_VALUE,HIDDEN) VALUES ('smtp.senderAddress',2,0,30,'',220,'openvpnals@localhost.localdomain',0);
