 ...
 * 
 * 
 * Bootstrap an OpenVPNALS server implementation. The first argument passed to
 ...
 * for the OpenVPNALS web application. This hides the server implementation
 * from the OpenVPNALS core and any of its extensions.
 * 
 */
public class Bootstrap {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String serverImplClassName = "net.openvpn.als.server.Main";
