...
public abstract class AbstractPropertyClass implements PropertyClass {
     ...
     * (non-Javadoc)
     * 
     * @see net.openvpn.als.properties.PropertyType#addPropertyDefinitionCategory(int,
     *      net.openvpn.als.properties.PropertyDefinitionCategory)
     */
     ...
     * (non-Javadoc)
     * 
     * @see net.openvpn.als.properties.PropertyType#getPropertyDefinitionCategory(int)
     */
     ...
     * (non-Javadoc)
     * 
     * @see net.openvpn.als.properties.PropertyType#removePropertyDefinitionCategory(int,
     *      net.openvpn.als.properties.PropertyDefinitionCategory)
     */
    ...
    /* (non-Javadoc)
     * @see net.openvpn.als.properties.PropertyType#deregisterPropertyDefinition(java.lang.String)
     */
     ...
     * (non-Javadoc)
     * 
     * @see net.openvpn.als.properties.PropertyType#getName()
     */
     ...
     * (non-Javadoc)
     * 
     * @see net.openvpn.als.properties.PropertyType#getPropertyDefinition(java.lang.String)
     */
     ...
     * (non-Javadoc)
     * 
     * @see net.openvpn.als.properties.PropertyType#getPropertyDefinitions()
     */
    ...
    /* (non-Javadoc)
     * @see net.openvpn.als.boot.PropertyClass#isDefinitionExists(java.lang.String)
     */
    ...
    /* (non-Javadoc)
     * @see net.openvpn.als.boot.PropertyClass#retrieveProperty(net.openvpn.als.boot.AbstractPropertyKey)
     */
    ...
    /* (non-Javadoc)
     * @see net.openvpn.als.boot.PropertyClass#storeProperty(net.openvpn.als.boot.AbstractPropertyKey, java.lang.String)
     */
     ...
     * (non-Javadoc)
     * 
     * @see net.openvpn.als.properties.PropertyType#registerPropertyDefinition(net.openvpn.als.boot.PropertyDefinition)
     */
    ...
    /* (non-Javadoc)
     * @see net.openvpn.als.boot.PropertyClass#commit()
     */
    ...
    /* (non-Javadoc)
     * @see net.openvpn.als.boot.PropertyClass#setAutoCommit(boolean)
     */
    ...
    /* (non-Javadoc)
     * @see net.openvpn.als.boot.PropertyClass#getCategories()
     */
    ...
    /* (non-Javadoc)
     * @see net.openvpn.als.boot.PropertyClass#isSupportsReplacementVariablesInValues()
     */
	...
	/* (non-Javadoc)
	 * @see net.openvpn.als.boot.PropertyClass#addPropertyDefinitionCategories(java.util.Collection)
	 */
	...
	/* (non-Javadoc)
	 * @see net.openvpn.als.boot.PropertyClass#addPropertyDefinitions(java.util.Collection)
	 */
	...
	/* (non-Javadoc)
	 * @see net.openvpn.als.boot.PropertyClass#clearPropertyDefinitionCategories()
	 */
	...
	/* (non-Javadoc)
	 * @see net.openvpn.als.boot.PropertyClass#clearPropertyDefinitions()
	 */
