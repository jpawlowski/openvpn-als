...
/**
 * Factory class to get an instance of the configure {@link net.openvpn.als.boot.Repository}.
 * <p>
 ...
 * the <i>openvpnals.repositoryClass</i> system property that should contain
...
public class RepositoryFactory {
    ...
    public static Repository getRepository() {
        if (instance != null)
            return instance;
        try {
            if (SystemProperties.get("openvpnals.repositoryClass") != null) {
                instance = (Repository) Class.forName(SystemProperties.get("openvpnals.repositoryClass")).newInstance();
            } else
