 ...
 * are not prefixed with <b>openvpnals</b>. 
 * <p>
 ...
 * with <b>openvpnals.[propertyName]</b> will be changed to use 
...
public class SystemProperties {
    ...
    public static String get(String propertyName, String defaultValue) {
        if(propertyName.startsWith("openvpnals.") && systemPropertyPrefix != null) {
