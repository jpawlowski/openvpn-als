...
/**
 * Whilst OpenVPNALS is largely a standard web application, it has
 ...
 * {@link net.openvpn.als.boot.ContextHolder#setContext(Context)}.
 * <p>
 * The instance of the context may then be accessed in the web application and
 * boot classes using {@link net.openvpn.als.boot.ContextHolder#getContext()}.
 * <p>
...
public interface Context {
    ...
    /**
     * Get the current version of OpenVPNALS.
     * 
    ...
    /**
     * Return the host name on which OpenVPNALS is running.
     * 
     * @return hostname
     */
    ...
    /**
     * Return the actual port OpenVPNALS is running on. This may be different
    ...
    /**
     * Get the root preferences node. Any component of OpenVPNALS core or its
