...
public class CustomWebApplicationContext extends WebApplicationContext {
    ...
    public CustomWebApplicationContext(boolean useDevConfig, ClassLoader bootLoader) throws Exception {
        ...
        setContextPath("/");
        setDefaultsDescriptor("/net/openvpn/als/boot/webdefault.xml");
        ...
        if("true".equals(SystemProperties.get("openvpnals.paranoidSessionManager", "true"))) {
     ...
     * {@link net.openvpn.als.boot.Context#addResourceBase(URL)}
     * 
     ...
     * <p>
     * This shouldn't be called directly, but through
     * {@link net.openvpn.als.boot.Context#removeResourceBase(URL)}
     * 
    ...
    public Resource getResource(String pathInContext) throws IOException {
        boolean fullResourceCache = SystemProperties.get("openvpnals.fullResourceCache",
            String.valueOf(!(SystemProperties.get("openvpnals.useDevConfig", "false").equals("true")))).equals("true");
        Resource r;
