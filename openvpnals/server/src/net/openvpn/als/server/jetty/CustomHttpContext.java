 ...
 * namespace of the main OpenVPNALS webapp. 
 */
public class CustomHttpContext extends HttpContext {
     ...
     * {@link net.openvpn.als.boot.Context#registerRequestHandler(RequestHandler)}
     * 
     ...
     * requests. See
     * {@link net.openvpn.als.boot.Context#deregisterRequestHandler(RequestHandler)}.
     * 
     * <p>
     * This shouldn't be called directly, but through
     * {@link net.openvpn.als.boot.Context#registerRequestHandler(RequestHandler)}
