 ...
 * <p>FIXME: Verify if this has any Java-specifisms due to usage of
 * of ByteArrayInputStream and ByteArrayOutputStream streaming classes.
 * For more information, take a look here:</p>
 *
 * <p>http://java.sun.com/j2se/1.4.2/docs/api/java/io/ByteArrayOutputStream.html</p>
 * 
