...
import com.adito.agent.client.WinRegistry;
...
import com.adito.agent.client.util.Messages;
import com.adito.agent.client.util.TunnelConfiguration;
import com.adito.agent.client.util.XMLElement;

/**
 * Extension of {@link AbstractApplicationLauncher} for use with the Adito Agent.
 */
public class AgentApplicationLauncher extends AbstractApplicationLauncher {
    ...
    public AgentApplicationLauncher(Agent vpn, String name, Hashtable parameters, String descriptor, ApplicationLauncherEvents events) {
        super(vpn.getConfiguration().getCacheDir(), "https", vpn.getUsername(), vpn.getAditoHost(), vpn.getAditoPort(), parameters, events);
        this.agent = vpn;
        this.name = name;
    ...
    /* (non-Javadoc)
     * @see com.adito.vpn.util.ApplicationLauncher#getApplicationDescriptor()
     */
