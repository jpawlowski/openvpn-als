...
<tiles:useAttribute ignore="true" name="content" scope="request" classname="java.lang.String"/> 
...
<tiles:useAttribute ignore="true" name="pageHeader" scope="request" classname="java.lang.String"/> 
...
<bean:define id="componentLayout">/WEB-INF/<core:themePath/>/componentLayout.jsp</bean:define>
<tiles:insert flush="false" beanName="componentLayout">
