...
class NTLM {
    ...
    /** Character encoding */
    public static final String DEFAULT_CHARSET = "ASCII"; //$NON-NLS-1$
     ...
     */
    public String getResponseFor(String message, String username, String password, String host, String domain) throws IOException {
    ...
    public String getType3Message(String user, String password, String host, String domain, byte[] nonce) throws IOException {
        ...
        prepareResponse(finalLength);
        byte[] ntlmssp = "NTLMSSP".getBytes(); //$NON-NLS-1$
        addBytes(ntlmssp);
        addByte((byte) 0);
        addByte((byte) 3);
        addByte((byte) 0);
