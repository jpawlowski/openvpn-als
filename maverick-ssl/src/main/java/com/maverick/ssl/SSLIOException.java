...
/**
 * This exception is thrown by the API whenever an {@link SSLException} cannot
 * be thrown i.e. from an InputStream read operation.
 * 
...
public class SSLIOException extends IOException {
    ...
    public SSLIOException(SSLException cause) {
