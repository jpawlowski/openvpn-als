...
import com.ovpnals.plugin.Plugin;
import com.ovpnals.plugin.PluginDefinition;
import com.ovpnals.plugin.PluginException;
import com.ovpnals.policyframework.Permission;
import com.ovpnals.policyframework.PolicyConstants;
import com.ovpnals.security.SessionInfo;
import com.ovpnals.security.UserAttributeDefinition;

/**
 * Sample implementation of a {@link Plugin} that amongst other things provides
 * a new {@link com.ovpnals.sample.Sample} resource that can be managed in
 * OpenVPN-ALS.
 * <p>
...
public class SamplePlugin implements Plugin {
     ...
     * (non-Javadoc)
     * 
     * @see com.ovpnals.plugin.Plugin#startPlugin()
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.ovpnals.plugin.Plugin#canStopPlugin()
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.ovpnals.plugin.Plugin#stopPlugin()
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.ovpnals.plugin.Plugin#getTilesConfigFile()
     */
    public String getTilesConfigFile() {
        return "/WEB-INF/ovpnals-sample-tiles-defs.xml";
    }

    /*
     * (non-Javadoc)
     * 
     * @see com.ovpnals.plugin.Plugin#initPlugin(com.ovpnals.plugin.PluginDefinition)
     */
    ...
    /* (non-Javadoc)
     * @see com.ovpnals.plugin.Plugin#installPlugin()
     */
    public void installPlugin() throws PluginException {        
    }

    /* (non-Javadoc)
     * @see com.ovpnals.plugin.Plugin#uninstallPlugin()
     */
