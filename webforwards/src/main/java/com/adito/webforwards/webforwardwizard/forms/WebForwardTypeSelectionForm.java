...
/**
 */
public class WebForwardTypeSelectionForm extends DefaultWizardForm {
    private static final int NO_TYPE_SELECTED = -1; 
    public static final String ATTR_TYPE = "type";
    private int type = WebForward.TYPE_TUNNELED_SITE;

    /**
     * Construtor
     */
    public WebForwardTypeSelectionForm() {
        super(true, false, "/WEB-INF/jsp/content/webforward/webforwardwizard/webForwardTypeSelection.jspf", "", false, false,
                        "webForwardTypeSelection", "webForwards", "webForwardWizard.webForwardTypeSelection", 1);
    }
    ...
    public ActionErrors validate(ActionMapping mapping, HttpServletRequest request) {
        if(isCommiting() && type == NO_TYPE_SELECTED) {
            ...
            errors.add(Globals.ERROR_KEY, new ActionMessage("webForwardWizard.webForwardTypeSelection.error.noSelection"));
            return errors;
        }
        return null;
    }
