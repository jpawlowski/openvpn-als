...
import net.openvpn.als.replacementproxy.ProxiedRequestDispatcher;
...
public abstract class AbstractAuthenticatingWebForwardHandler implements RequestHandler {
	...
	protected final static String sessionCookie = SystemProperties.get("openvpnals.cookie", "JSESSIONID");
