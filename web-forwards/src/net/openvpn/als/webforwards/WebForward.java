 ...
 * using OpenVPNALSs <strong>Web Forwarding </strong> feature.
 *
 * <p>
 ...
 *
 * <p>
 * Instances are provided by the {@link net.openvpn.als.security.SystemDatabase}
...
public interface WebForward extends Resource {
     ...
     * {@link net.openvpn.als.replacementproxy.actions.LaunchReplacementProxyAction}
     ...
     * a special URL always pointing to the OpenVPNALS server.
     * </p>
     *
     * <p>
     ...
     * {@link net.openvpn.als.security.SystemDatabase#getReplacementsForContent(String, int, String, String)}.
     ...
     * by OpenVPNALS that are for paths at or below the specified destination
