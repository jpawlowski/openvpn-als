...
import net.openvpn.als.replacementproxy.DefaultReplacement;
 ...
 * a JDBC compliant database to store OpenVPN-ALS's web forward configuration
 * and resources.
 */
public class JDBCWebForwardDatabase implements WebForwardDatabase, CoreListener {
    ...
    public JDBCWebForwardDatabase() {
        int maxObjects = 1000;
        try {
            maxObjects = Integer.parseInt(SystemProperties.get("openvpnals.jdbcSystemDatabase.replacementsCache", "10000"));
        } catch (Exception e) {
        }
...
//        }
     ...
     * (non-Javadoc)
     * 
     * @see net.openvpn.als.webforwards.WebForwardDatabase#getReverseProxyWebForward(net.openvpn.als.security.User,
     *      java.lang.String)
     */
     ...
     * (non-Javadoc)
     * 
     * @see net.openvpn.als.webforwards.WebForwardDatabase#getWebForward(int)
     */
     ...
     * (non-Javadoc)
     * 
     * @see net.openvpn.als.webforwards.WebForwardDatabase#getWebForwards(int)
     */
     ...
     * (non-Javadoc)
     * 
     * @see net.openvpn.als.webforwards.WebForwardDatabase#getWebForwards()
     */
    ...
    /* (non-Javadoc)
     * @see net.openvpn.als.webforwards.WebForwardDatabase#getWebForward(java.lang.String, int)
     */
     ...
     * (non-Javadoc)
     * 
     * @see net.openvpn.als.webforwards.WebForwardDatabase#reverseProxyPathExists(java.lang.String)
     */
     ...
     * (non-Javadoc)
     * 
     * @see net.openvpn.als.webforwards.WebForwardDatabase#createWebForward(net.openvpn.als.webforwards.WebForward)
     */
     ...
     * (non-Javadoc)
     * 
     * @see net.openvpn.als.webforwards.WebForwardDatabase#updateWebForward(net.openvpn.als.webforwards.WebForward)
     */
     ...
     * (non-Javadoc)
     * 
     * @see net.openvpn.als.webforwards.WebForwardDatabase#deleteWebForward(int)
     */
     ...
     * (non-Javadoc)
     * 
     * @see net.openvpn.als.security.SystemDatabase#getReplacementsForContent(java.lang.String,
     ...
     * (non-Javadoc)
     * 
     * @see net.openvpn.als.security.SystemDatabase#deleteReplacement(int)
     */
     ...
     * (non-Javadoc)
     * 
     * @see net.openvpn.als.security.SystemDatabase#updateReplacement(net.openvpn.als.services.Replacement)
     */
     ...
     * (non-Javadoc)
     * 
     * @see net.openvpn.als.security.SystemDatabase#createReplacement(net.openvpn.als.services.Replacement)
     */
     ...
     * (non-Javadoc)
     * 
     * @see net.openvpn.als.security.SystemDatabase#getReplacements()
     */
     ...
     * (non-Javadoc)
     * 
     * @see net.openvpn.als.security.SystemDatabase#getReplacement(int)
     */
