...
public class ProxiedRequestDispatcher {
	...
	final static String sessionIdCookieName = SystemProperties.get("openvpnals.cookie", "JSESSIONID");
						...
						try {
							...
							if (refUrl.getFile() != null) {
							    ...
							    if(uriDetails.getProxiedURL() == null) {
							         ...
							         * way a target server won't know its a request from OpenVPN-ALS by
