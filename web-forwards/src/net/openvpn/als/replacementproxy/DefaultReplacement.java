...
/**
 * Default implementation of the {@link net.openvpn.als.replacementproxy.Replacement}
 * interface.
 */
...
public class DefaultReplacement implements Replacement {
     ...
     * (non-Javadoc)
     * 
     * @see net.openvpn.als.services.Replacement#getMimeType()
     */
     ...
     * (non-Javadoc)
     * 
     * @see net.openvpn.als.services.Replacement#getSitePattern()
     */
     ...
     * (non-Javadoc)
     * 
     * @see net.openvpn.als.services.Replacement#getSequence()
     */
     ...
     * (non-Javadoc)
     * 
     * @see net.openvpn.als.services.Replacement#getMatchPattern()
     */
     ...
     * (non-Javadoc)
     * 
     * @see net.openvpn.als.services.Replacement#getReplacePattern()
     */
     ...
     * (non-Javadoc)
     * 
     * @see net.openvpn.als.services.Replacement#setMatchPattern(java.lang.String)
     */
     ...
     * (non-Javadoc)
     * 
     * @see net.openvpn.als.services.Replacement#setMimeType(java.lang.String)
     */
     ...
     * (non-Javadoc)
     * 
     * @see net.openvpn.als.services.Replacement#setReplacePattern(java.lang.String)
     */
     ...
     * (non-Javadoc)
     * 
     * @see net.openvpn.als.services.Replacement#setSitePattern(java.lang.String)
     */
     ...
     * (non-Javadoc)
     * 
     * @see net.openvpn.als.services.Replacement#getReplaceType()
     */
     ...
     * (non-Javadoc)
     * 
     * @see net.openvpn.als.services.Replacement#setReplaceType(int)
     */
