...
package com.ovpnals.agent.client.gui.swt;
...
public class SWTSystemTrayGUI implements AgentClientGUI {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.ovpnals.vpn.client.VPNClientGUI#init(com.ovpnals.vpn.client.VPNClientGUIListener)
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.ovpnals.agent.client.AgentClientGUI#popup(com.ovpnals.agent.client.AgentClientGUI.ActionCallback,
