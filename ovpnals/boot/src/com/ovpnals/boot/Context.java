...
/**
 * Whilst OpenVPN-ALS is largely a standard web application, it has
 ...
 * {@link com.ovpnals.boot.ContextHolder#setContext(Context)}.
 * <p>
 * The instance of the context may then be accessed in the web application and
 * boot classes using {@link com.ovpnals.boot.ContextHolder#getContext()}.
 * <p>
...
public interface Context {
    ...
    /**
     * Get the current version of OpenVPN-ALS.
     * 
    ...
    /**
     * Return the host name on which OpenVPN-ALS is running.
     * 
     * @return hostname
     */
    ...
    /**
     * Return the actual port OpenVPN-ALS is running on. This may be different
    ...
    /**
     * Get the root preferences node. Any component of OpenVPN-ALS core or its
