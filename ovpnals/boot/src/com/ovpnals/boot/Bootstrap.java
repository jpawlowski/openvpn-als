 ...
 * 
 * 
 * Bootstrap an OpenVPN-ALS server implementation. The first argument passed to
 ...
 * for the OpenVPN-ALS web application. This hides the server implementation
 * from the OpenVPN-ALS core and any of its extensions.
 * 
 */
public class Bootstrap {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String serverImplClassName = "com.ovpnals.server.Main";
