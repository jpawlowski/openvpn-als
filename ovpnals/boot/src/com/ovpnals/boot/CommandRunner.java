...
public class CommandRunner extends Thread {
    ...
    public void runCommand() throws Exception {
        try {
            ...
            if (log.isDebugEnabled() || "true".equals(SystemProperties.get("ovpnals.debugSystemCommands", "false"))) {
                ...
                if("true".equals(SystemProperties.get("ovpnals.debugSystemCommands", "false"))) {
