...
/**
 * Default implementation of a {@link com.ovpnals.boot.PropertyDefinition}.
 * <p>
 ...
 * <code>com.ovpnals.input.validators.IntegerValidator(minValue=10,maxValue=20)</code>.
 * 
 */
public class DefaultPropertyDefinition implements PropertyDefinition, Comparable<PropertyDefinition>, Serializable {
        ...
        switch (type) {
            ...
            case TYPE_INTEGER:
                if (this.validationString == null || this.validationString.equals("")) {
                    this.validationString = "com.ovpnals.input.validators.IntegerValidator(replacementVariables="
     ...
     * (non-Javadoc)
     * 
     * @see com.ovpnals.boot.PropertyDefinition#getMessageResourcesKey()
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.ovpnals.boot.PropertyDefinition#getCategory()
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.ovpnals.boot.PropertyDefinition#getName()
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.ovpnals.boot.PropertyDefinition#getType()
     */
    public int getType() {
        return type;
    }
     ...
     * (non-Javadoc)
     * 
     * @see com.ovpnals.boot.PropertyDefinition#getTypeMeta()
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.ovpnals.boot.PropertyDefinition#setTypeMeta(java.lang.String)
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.ovpnals.boot.PropertyDefinition#getDefaultValue()
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.ovpnals.boot.PropertyDefinition#setDefaultValue(java.lang.String)
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.ovpnals.boot.PropertyDefinition#getSortOrder()
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.ovpnals.boot.PropertyDefinition#getTypeMetaObject()
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.ovpnals.boot.PropertyDefinition#isHidden()
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.ovpnals.boot.PropertyDefinition#validate(java.lang.String,
     ...
     * (non-Javadoc)
     * 
     * @see com.ovpnals.boot.PropertyDefinition#isRestartRequired()
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.ovpnals.boot.PropertyDefinition#setValidationString(java.lang.String)
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.ovpnals.boot.PropertyDefinition#getPropertyClass()
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.ovpnals.boot.PropertyDefinition#init(com.ovpnals.boot.PropertyClass)
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.ovpnals.boot.PropertyDefinition#formatAttributeValue(java.lang.Object)
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.ovpnals.boot.PropertyDefinition#getVisibility()
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.ovpnals.boot.PropertyDefinition#parseValue(java.lang.String)
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.ovpnals.boot.PropertyDefinition#setVisibility(int)
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.ovpnals.boot.PropertyDefinition#getDescriptionMessageResourceKey()
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.ovpnals.boot.PropertyDefinition#getNameMessageResourceKey()
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.ovpnals.boot.PropertyDefinition#getCategoryLabel()
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.ovpnals.boot.PropertyDefinition#getLabel()
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.ovpnals.boot.PropertyDefinition#setCategoryLabel(java.lang.String)
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.ovpnals.boot.PropertyDefinition#setLabel(java.lang.String)
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.ovpnals.boot.PropertyDefinition#getDescription()
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.ovpnals.boot.PropertyDefinition#setDescription(java.lang.String)
     */
