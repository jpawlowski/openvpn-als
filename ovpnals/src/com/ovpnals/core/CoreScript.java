 ...
 * OpenVPN-ALS user interface. For example, the Xtra plugin has its own
 ...
 * class and registers it using {@link com.ovpnals.core.CoreServlet#addPageScript(CoreScript)}.
