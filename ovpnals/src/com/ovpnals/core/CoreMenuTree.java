...
public class CoreMenuTree extends MenuTree {
    ...
    public CoreMenuTree() {
        ...
        addMenuItem("help", new MenuItem("referenceGuidePDF", "navigation", "http://localhost/products/ovpnals/documentation/OpenVPN-ALS_Administrators_Guide.pdf", 300, true, "_blank", SessionInfo.HELP_CONTEXT));
        
        addMenuItem("help", new MenuItem("referenceGuideHTML", "navigation", "http://localhost/products/ovpnals/documentation/html/w2wfrm.htm", 300, true, "_blank", SessionInfo.HELP_CONTEXT));
