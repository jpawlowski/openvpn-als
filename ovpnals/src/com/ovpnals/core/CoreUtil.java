...
import com.ovpnals.core.actions.CoreAction;
import com.ovpnals.core.actions.LicenseAgreementDispatchAction;
...
import com.ovpnals.vfs.store.downloads.TempStore;
...
public class CoreUtil {
    ...
    public static void updateEventsTable(String bundle, Class clazz) {
        Plugin auditingPlugin = PluginType.getPlugin("ovpnals-enterprise-auditing");
