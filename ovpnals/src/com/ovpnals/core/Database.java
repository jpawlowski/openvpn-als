...
/**
 * OpenVPN-ALS stores most of its configuration and resources in one of
 * the <i>Database</i> implementations.
 * <p>
 * Current databases include {@link com.ovpnals.properties.PropertyDatabase},
 * {@link com.ovpnals.security.SystemDatabase} and 
 * {@link com.ovpnals.policyframework.PolicyDatabase}.
...
public interface Database {
     ...
     * relevant.
     * <p>
     * For example, OpenVPN-ALS allows the administrator to select the
     * source of <i>User Accounts</i>. The administrator chooses to use
     * the <i>Active Directory User Database</i>. Because OpenVPN-ALS does
