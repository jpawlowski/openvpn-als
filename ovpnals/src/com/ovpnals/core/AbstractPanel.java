...
/**
 * Abstract implementation of a {@link com.ovpnals.core.Panel}.
 */
public abstract class AbstractPanel implements Panel {
    ...
    /* (non-Javadoc)
     * @see com.ovpnals.core.Panel#isDropable()
     */
    ...
    /* (non-Javadoc)
     * @see com.ovpnals.core.Panel#isDragable()
     */
    ...
    /* (non-Javadoc)
     * @see com.ovpnals.core.Panel#getPlacement()
     */
    ...
    /* (non-Javadoc)
     * @see com.ovpnals.core.Panel#getWeight()
     */
    ...
    /* (non-Javadoc)
     * @see com.ovpnals.core.Panel#getId()
     */
    public String getId() {
        return id;
    }
    ...
    /* (non-Javadoc)
     * @see com.ovpnals.core.Panel#getBundle()
     */
    ...
    /* (non-Javadoc)
     * @see com.ovpnals.core.Panel#getTileIncludePath(javax.servlet.jsp.PageContext)
     */
    ...
    /* (non-Javadoc)
     * @see com.ovpnals.core.Panel#isCloseable()
     */
    ...
    /* (non-Javadoc)
     * @see com.ovpnals.core.Panel#getDefaultFrameState()
     */
	...
	/* (non-Javadoc)
	 * @see com.ovpnals.core.Panel#setDragable(boolean)
	 */
	...
	/* (non-Javadoc)
	 * @see com.ovpnals.core.Panel#setDropable(boolean)
	 */
    ...
    /* (non-Javadoc)
     * @see com.ovpnals.core.Panel#isMinimizable()
     */
	...
	/* (non-Javadoc)
	 * @see com.ovpnals.core.Panel#setMinimizable(boolean)
	 */
