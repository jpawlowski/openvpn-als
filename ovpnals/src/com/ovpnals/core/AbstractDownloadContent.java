...
/**
 * Abstract implementation of {@link com.ovpnals.core.DownloadContent}
...
public abstract class AbstractDownloadContent implements DownloadContent {
    ...
    /* (non-Javadoc)
     * @see com.ovpnals.core.DownloadContent#sendDownload(javax.servlet.http.HttpServletResponse, javax.servlet.http.HttpServletRequest)
     */
    public abstract void sendDownload(HttpServletResponse response, HttpServletRequest request) throws Exception;

    /* (non-Javadoc)
     * @see com.ovpnals.core.DownloadContent#completeDownload(com.ovpnals.security.SessionInfo)
     */
    ...
    /* (non-Javadoc)
     * @see com.ovpnals.core.DownloadContent#getId()
     */
    public int getId() {
        return this.id;
    }
    ...
    /* (non-Javadoc)
     * @see com.ovpnals.core.DownloadContent#setId(int)
     */
    ...
    /* (non-Javadoc)
     * @see com.ovpnals.core.DownloadContent#getForward()
     */
    ...
    /* (non-Javadoc)
     * @see com.ovpnals.core.DownloadContent#getMessageKey()
     */
    ...
    /* (non-Javadoc)
     * @see com.ovpnals.core.DownloadContent#getMessageResourcesKey()
     */
    ...
    /* (non-Javadoc)
     * @see com.ovpnals.core.DownloadContent#getMessageArg0()
     */
    ...
    /* (non-Javadoc)
     * @see com.ovpnals.core.DownloadContent#getMessageArg1()
     */
    ...
    /* (non-Javadoc)
     * @see com.ovpnals.core.DownloadContent#getMessageArg2()
     */
    ...
    /* (non-Javadoc)
     * @see com.ovpnals.core.DownloadContent#getMessageArg3()
     */
    ...
    /* (non-Javadoc)
     * @see com.ovpnals.core.DownloadContent#getMessageArg4()
     */
    ...
    /* (non-Javadoc)
     * @see com.ovpnals.core.DownloadContent#getMessageForward()
     */
