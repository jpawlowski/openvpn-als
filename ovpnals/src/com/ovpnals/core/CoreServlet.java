...
import com.ovpnals.agent.AgentRequestHandler;
...
import com.ovpnals.extensions.ApplicationParameters;
import com.ovpnals.extensions.ExtensionException;
import com.ovpnals.extensions.forms.ConfigureExtensionsForm;
import com.ovpnals.extensions.store.ExtensionStore;
import com.ovpnals.jdbc.JDBCUserDatabase;
import com.ovpnals.jdbc.hsqldb.EmbeddedHSQLDBServer;
...
import com.ovpnals.keystore.wizards.types.RootServerCertificateImportType;
import com.ovpnals.keystore.wizards.types.ServerAuthenticationKeyImportType;
import com.ovpnals.keystore.wizards.types.TrustedServerCertificateImportType;
import com.ovpnals.keystore.wizards.types._3SPPurchaseImportType;
import com.ovpnals.language.Language;
import com.ovpnals.language.LanguagePackDefinition;
import com.ovpnals.language.LanguagePackManager;
...
import com.ovpnals.notification.agent.AgentMessageSink;
import com.ovpnals.notification.smtp.SMTPMessageSink;
...
import com.ovpnals.properties.impl.policyattributes.PolicyAttributes;
import com.ovpnals.properties.impl.profile.ProfileProperties;
...
import com.ovpnals.requesthandler.test.TestRequestHandler;
...
import com.ovpnals.security.EmbeddedClientAuthenticationModule;
import com.ovpnals.security.HTTPAuthenticationModule;
...
import com.ovpnals.services.CoreEventService;
import com.ovpnals.services.CoreEventServiceImpl;
import com.ovpnals.services.MessageResourceService;
import com.ovpnals.table.TableItemActionMenuTree;
import com.ovpnals.tasks.timer.StoppableTimer;

/**
 * Main controlling servlet. This extends struts own
 * {@link org.apache.struts.action.ActionServlet}. Pretty much all OpenVPN-ALS
 * actions will come through here.
 * <p>
 * Many features in OpenVPN-ALS require access to this servlet as it manages
...
public class CoreServlet extends ActionServlet implements ContextListener, MessageResourceService {
     ...
     * (non-Javadoc)
     * 
     * @see com.ovpnals.core.CoreEventManager#addCoreListener(com.ovpnals.core.CoreListener)
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.ovpnals.core.CoreEventManager#removeCoreListener(com.ovpnals.core.CoreListener)
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.ovpnals.core.CoreEventManager#fireCoreEvent(com.ovpnals.core.CoreEvent)
     */
    ...
    protected void initOther() throws ServletException {
        ...
        applicationStoreResources = (CoreMessageResources) messageResourcesFactory
                        .createResources("com.ovpnals.applications.store.ApplicationResources");
    ...
    protected void activateCore() throws ServletException {
        ...
        if ("true".equalsIgnoreCase(SystemProperties.get("ovpnals.disableExtensions"))) {
        ...
        if (!ContextHolder.getContext().isSetupMode()) {
            if (SystemProperties.get("ovpnals.testing", "false").equals("true")) {
        ...
        if (!Property.getPropertyBoolean(new SystemConfigKey("ui.rssFeeds")) 
        		|| SystemProperties.get("ovpnals.disable.rssFeeds", "false").equals("true")) {
            if (log.isInfoEnabled())
    ...
    public void init() throws ServletException {
        ...
        try {
            ...
            if (SystemProperties.get("ovpnals.disableNewSSLEngine", "false").equals("true"))
            ...
            dbServer = new EmbeddedHSQLDBServer("true".equalsIgnoreCase(SystemProperties.get("ovpnals.hsqldb.tcpipServer",
                "false")));
    ...
    protected ModuleConfig initModuleConfig(String prefix, String paths) throws ServletException {
        ...
        moduleConfig.getControllerConfig().setProcessorClass("com.ovpnals.core.CoreRequestProcessor");
        return moduleConfig;
    }
    ...
    protected void initCore() throws ServletException {
         ...
         */
        if (!("false".equals(SystemProperties.get("ovpnals.useMaverickSSL", "true")))) {
            try {
                if (log.isInfoEnabled())
    ...
    void checkDevEnvironment() throws ServletException {
        devConfig = "true".equalsIgnoreCase(SystemProperties.get("ovpnals.useDevConfig", "false"));
