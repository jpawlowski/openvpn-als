...
/**
 * 
 * Generic action to be used for all authenticated actions by the OpenVPN-ALS
 ...
 * request path.
 * @since 0.1
 * @see com.ovpnals.core.actions.AuthenticatedDispatchAction
 */
