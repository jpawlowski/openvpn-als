...
/**
 * <p>
 * Property databases are a core component of OpenVPN-ALS and are used to store 
 ...
 * each unique <i>id</i> there must have been a single {@link com.ovpnals.boot.PropertyDefinition}
 ...
 * its category ID and other information. See {@link com.ovpnals.boot.PropertyDefinition}
 ...
 *  <p>
 *  Only property definitions that have a visibility of {@link com.ovpnals.boot.PropertyDefinition#PROFILE}
 ...
 *  
 *  Properties that are only used for configuring the {@link com.ovpnals.boot.Context}
 *  implementation in use. Properties of this type are different in that their
 *  values are stored and retrieved using {@link com.ovpnals.boot.Context#setContextProperty(String, String)}
 *  and {@link com.ovpnals.boot.Context#getContextProperty(String)}. The 
 *  property definition objects are retrieve using {@link com.ovpnals.boot.Context#getContextPropertyDefinitions()}
 ...
 *  {@link com.ovpnals.boot.PropertyDefinition#SYSTEM_CONFIGURATION}
 *  
 ...
 *  {@link com.ovpnals.boot.PropertyDefinition#isHidden()} is called.
 */
...
public interface PropertyDatabase extends Database {
     ...
     * use methods in {@link com.ovpnals.properties.Property}.
     * 
     * @param key1 key 1
     * @param key2 key 2
     * @param key3 key 3
