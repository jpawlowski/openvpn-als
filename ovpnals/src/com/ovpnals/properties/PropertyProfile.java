 ...
 * {@link com.ovpnals.boot.PropertyDefinition#PROFILE} may exist in global
 ...
 * {@link com.ovpnals.policyframework.Resource} so is subject ot all
 * the rules imposed on by the <i>Policy Framework</i>. In fact it is a
 * specialised type of resource known as a
 * {@link com.ovpnals.policyframework.OwnedResource}. *
 */
