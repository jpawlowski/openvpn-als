...
package com.ovpnals.properties.attributes.wizards.forms;
...
import com.ovpnals.properties.attributes.forms.AttributeDefinitionForm;
import com.ovpnals.properties.attributes.wizards.actions.AttributeDefinitionDetailsAction;
import com.ovpnals.properties.attributes.wizards.actions.AttributeDefinitionOptionsAction;
...
public class AttributeDefinitionOptionsForm extends DefaultWizardForm {
    ...
    public void init(AbstractWizardSequence sequence, HttpServletRequest request) throws Exception {
        ...
        validationString  = (String)sequence.getAttribute(AttributeDefinitionOptionsAction.ATTR_VALIDATION_STRING, "com.ovpnals.input.validators.StringValidator(minLength=0,maxLength=30,trim=true,regExp=,pattern=)");
