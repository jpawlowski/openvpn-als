...
import com.ovpnals.properties.PropertyDatabase;
...
/**
 * Implementation of a {@link com.ovpnals.properties.PropertyDatabase} that
 ...
 * <code>ovpnals.jdbcPropertyDatabase.cacheTTL</code> and
 * <code>ovpnals.jdbcPropertyDatabase.cacheMaxObjs</code>
 */
...
public class JDBCPropertyDatabase implements PropertyDatabase {
    ...
    final static Long CACHE_TTL = new Long(SystemProperties.get("ovpnals.jdbcPropertyDatabase.cacheTTL", "180000"));
    final static Integer CACHE_MAXOBJS = new Integer(SystemProperties.get("ovpnals.jdbcPropertyDatabase.cacheMaxObjs", "2000"));
    ...
    public void open(CoreServlet controllingServlet) throws Exception {
        String dbName = SystemProperties.get("ovpnals.propertyDatabase.jdbc.dbName", "explorer_configuration");
     ...
     * (non-Javadoc)
     * 
     * @see com.ovpnals.boot.PropertyDatabase#storeProperty(int,
    ...
    /* (non-Javadoc)
     * @see com.ovpnals.properties.PropertyDatabase#getPropertyProfiles(java.lang.String, boolean, int)
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.ovpnals.boot.PropertyDatabase#getPropertyProfile(int)
     */
    ...
    /* (non-Javadoc)
     * @see com.ovpnals.properties.PropertyDatabase#createPropertyProfile(java.lang.String, java.lang.String, java.lang.String, int, int)
     */
    ...
    /* (non-Javadoc)
     * @see com.ovpnals.properties.PropertyDatabase#updatePropertyProfile(int, java.lang.String, java.lang.String)
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.ovpnals.boot.PropertyDatabase#deletePropertyProfile(int)
     */
    ...
    /* (non-Javadoc)
     * @see com.ovpnals.properties.PropertyDatabase#getPropertyProfile(java.lang.String, java.lang.String, int)
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.ovpnals.security.UserDatabase#loadAttributes(com.ovpnals.security.User)
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.ovpnals.properties.PropertyDatabase#createAttributeDefinition(com.ovpnals.properties.AttributeDefinition)
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.ovpnals.properties.PropertyDatabase#deleteAttributeDefinition(java.lang.String,
     *      java.lang.String)
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.ovpnals.properties.PropertyDatabase#updateAttributeDefinition(com.ovpnals.properties.AttributeDefinition)
     */
