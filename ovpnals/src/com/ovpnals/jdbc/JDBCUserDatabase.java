...
public class JDBCUserDatabase extends DefaultUserDatabase {
    ...
    public void open(CoreServlet controllingServlet, Realm realm) throws Exception {
        ...
        String dbName = SystemProperties.get("ovpnals.userDatabase.jdbc.dbName", "explorer_configuration");
	...
	/* (non-Javadoc)
	 * @see com.ovpnals.security.UserDatabase#logon(java.lang.String, java.lang.String)
	 */
