...
/**
 * Abstract implementation of an {@link com.ovpnals.security.AuthenticationModule}
 * that simply checks the supplied authentication details against the information
 * in the current {@link com.ovpnals.security.UserDatabase}.
 */
public abstract class AbstractPasswordAuthenticationModule implements AuthenticationModule {
     ...
     * (non-Javadoc)
     *
     * @see com.ovpnals.security.AuthenticationModule#getName()
     */
     ...
     * (non-Javadoc)
     *
     * @see com.ovpnals.security.AuthenticationModule#init(com.ovpnals.security.AuthenticationSession)
     */
     ...
     * (non-Javadoc)
     *
     * @see com.ovpnals.security.AuthenticationModule#startAuthentication(javax.servlet.http.HttpServletRequest,
