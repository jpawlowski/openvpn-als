...
/**
 */
public class EnableAuthenticationSchemeAction extends TableItemAction {

    /**
     * Default constructor
     */
    public EnableAuthenticationSchemeAction() {
        super("enable", "security", 300, "", false, SessionInfo.MANAGEMENT_CONSOLE_CONTEXT,
    ...
    public String getPath(AvailableTableItemAction availableItem) {
        ...
        return "/showAuthenticationSchemes.do?actionTarget=enable&selectedResource=" + item.getResource().getResourceId();
    }
