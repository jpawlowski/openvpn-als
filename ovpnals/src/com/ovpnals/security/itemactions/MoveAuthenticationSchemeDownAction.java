...
package com.ovpnals.security.itemactions;
...
/**
 */
public class MoveAuthenticationSchemeDownAction extends TableItemAction {

    /**
     * Default constructor
     */
    public MoveAuthenticationSchemeDownAction() {
        super("moveDown", "security", 600, "", true, SessionInfo.MANAGEMENT_CONSOLE_CONTEXT,
    ...
    public String getPath(AvailableTableItemAction availableItem) {
        ...
        return "/showAuthenticationSchemes.do?actionTarget=moveDown&selectedResource=" + item.getResource().getResourceId();
    }

    @Override
    public boolean isEnabled(AvailableTableItemAction availableItem) {
        AuthenticationSchemeSequenceItem item = (AuthenticationSchemeSequenceItem)availableItem.getRowItem();
        return item.isCanMoveDown();
    }
}
