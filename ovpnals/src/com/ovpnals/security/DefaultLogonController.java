...
import com.ovpnals.core.ServletRequestAdapter;
import com.ovpnals.core.ServletResponseAdapter;
...
import com.ovpnals.security.actions.PromptForPrivateKeyPassphraseDispatchAction;
import com.ovpnals.security.actions.UpdatePrivateKeyPassphraseDispatchAction;
import com.ovpnals.setup.SystemInformationProvider;
import com.ovpnals.setup.SystemInformationRegistry;
import com.ovpnals.util.TicketGenerator;

/**
 * This class is the default implementation of the
 * {@link com.ovpnals.security.LogonController} and maintains and validates
...
public class DefaultLogonController implements LogonController {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.ovpnals.security.LogonController#init()
	 */
	public void init() {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.ovpnals.security.LogonController#isAdministrator(com.ovpnals.policyframework.Principal)
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.ovpnals.security.LogonController#addSessionTimeoutBlock(javax.servlet.http.HttpSession,
	 *      java.lang.String)
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.ovpnals.security.LogonController#removeSessionTimeoutBlock(javax.servlet.http.HttpSession,
	 *      int)
	 */
	...
	public void initialiseSession(HttpSession session, User user) throws UserDatabaseException {
		...
		String logonInfo = MessageResources.getMessageResources("com.ovpnals.navigation.ApplicationResources")
	...
	public AccountLock checkForAccountLock(String username, String realmName) throws SecurityErrorException,
		...
		AccountLock lock = "true".equals(SystemProperties.get("ovpnals.recoveryMode", "false")) ? null
	...
	// // Get the current lock (if any)
	// AccountLock lock =
	// "true".equals(SystemProperties.get("ovpnals.recoveryMode", "false")) ?
	// null
	// : (AccountLock) lockedUsers.get(username);
	// // If the user is currently locked, check if the lock has expired yeet
	...
	private void refreshLogonTicket(HttpServletRequest request, HttpServletResponse response, String logonTicket)
		 ...
		 */
		try {
			String sessionIdentifier = SystemProperties.get("ovpnals.cookie", "JSESSIONID");
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.ovpnals.security.LogonController#applyMenuItemChanges(javax.servlet.http.HttpServletRequest)
	 */
