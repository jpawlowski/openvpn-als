...
public class AgentTunnel extends MultiplexedConnection implements
	...
	/* (non-Javadoc)
	 * @see com.ovpnals.boot.RequestHandlerTunnel#tunnel(java.io.InputStream, java.io.OutputStream)
	 */
	...
	public boolean isAlive(MultiplexedConnection con) {
		...
		/* In the context of OpenVPN-ALS returning true here is OK as timeouts
