...
public class AgentManager {
    ...
    AgentManager() {
        ...
        if (SystemProperties.get("ovpnals.agent.debug", "").equals("enabled")) {
            types.put(DefaultAgentCallback.DEFAULT_AGENT_TYPE, new DummyAgentCallback());
        } else if (SystemProperties.get("ovpnals.agent.debug", "").equals("interactive")) {
            types.put(DefaultAgentCallback.DEFAULT_AGENT_TYPE, new InteractiveAgentCallback());
        } else if (SystemProperties.get("ovpnals.agent.debug", "").equals("attach")) {
