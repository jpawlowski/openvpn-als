...
import com.ovpnals.properties.PropertyItemImpl;
...
public abstract class AbstractWizardPropertiesForm extends AbstractWizardForm implements PropertiesForm, TabModel {
     ...
     * (non-Javadoc)
     * 
     * @see com.ovpnals.properties.forms.PropertiesForm#getCategoryDefinitions()
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.ovpnals.properties.forms.PropertiesForm#getEnabled()
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.ovpnals.properties.forms.PropertiesForm#getParentCategory()
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.ovpnals.properties.forms.PropertiesForm#getPropertyItem(int)
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.ovpnals.properties.forms.PropertiesForm#getPropertyItems()
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.ovpnals.properties.forms.PropertiesForm#setCategoryDefinitions(java.util.List)
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.ovpnals.properties.forms.PropertiesForm#setPropertyItem(int,
     *      com.ovpnals.applications.PropertyItem)
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.ovpnals.properties.forms.PropertiesForm#setPropertyItems(com.ovpnals.applications.PropertyItem[])
     */
