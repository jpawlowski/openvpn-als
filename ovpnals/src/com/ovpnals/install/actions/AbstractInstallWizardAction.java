...
public abstract class AbstractInstallWizardAction extends AbstractWizardAction {
    ...
    /* (non-Javadoc)
	 * @see com.ovpnals.wizard.actions.AbstractWizardAction#cancel(org.apache.struts.action.ActionMapping, org.apache.struts.action.ActionForm, javax.servlet.http.HttpServletRequest, javax.servlet.http.HttpServletResponse)
	 */
	@Override
