 ...
 * {@link com.ovpnals.policyframework.PolicyDatabase} that provides basic
...
public abstract class AbstractPolicyDatabase implements PolicyDatabase {
     ...
     * (non-Javadoc)
     * 
     * @see com.ovpnals.policyframework.PolicyDatabase#registerResourceType(com.ovpnals.policyframework.ResourceType)
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.ovpnals.policyframework.PolicyDatabase#deregisterResourceType(com.ovpnals.policyframework.ResourceType)
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.ovpnals.policyframework.PolicyDatabase#getResourceType(int)
     */
    ...
    /* (non-Javadoc)
     * @see com.ovpnals.policyframework.PolicyDatabase#getResourceTypes(java.lang.String)
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.ovpnals.policyframework.PolicyDatabase#getResourceTypeCount()
     */
