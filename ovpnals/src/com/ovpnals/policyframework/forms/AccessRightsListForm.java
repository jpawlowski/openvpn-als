...
/**
 * Implementation of a
 * {@link com.ovpnals.policyframework.forms.AbstractResourcesForm} which
 * contains a model of {@link com.ovpnals.policyframework.AccessRightsItem}
 * instances.
 */
public class AccessRightsListForm extends AbstractResourcesForm<AccessRightsItem> {
    ...
    /**
     * Implementation of a
     * {@link com.ovpnals.policyframework.ResourceItemModel} which is a
     * model of {@link com.ovpnals.policyframework.AccessRightsItem}
     * instances.
     */
    static class AccessRightsModel extends ResourceItemModel<AccessRightsItem> {
         ...
         * (non-Javadoc)
         * 
         * @see com.ovpnals.policyframework.ResourceItemModel#getColumnCount()
         */
         ...
         * (non-Javadoc)
         * 
         * @see com.ovpnals.policyframework.ResourceItemModel#getColumnName(int)
         */
