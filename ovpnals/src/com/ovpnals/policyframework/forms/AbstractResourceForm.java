...
/**
 * Abstract implementation of {@link com.ovpnals.core.forms.CoreForm} that
 * allows editing of {@link com.ovpnals.policyframework.Resource} instances.
 * 
...
public abstract class AbstractResourceForm<T extends Resource> extends CoreForm implements TabModel {
    ...
    /**
     * If this is an {@link com.ovpnals.policyframework.OwnedResource}
