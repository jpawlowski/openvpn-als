...
/**
 * Abstract action for use by action implementations that returns XML documents 
 * for use by Ajax scripts.
 * <p>
 * Implementations will probably require some attributes to be passed. 
 */

public abstract class AbstractAjaxXMLAction extends AuthenticatedAction {
    
    final static Log log = LogFactory.getLog(AbstractAjaxXMLAction.class);
