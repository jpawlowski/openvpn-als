...
public abstract class AbstractStore implements VFSStore {
	...
	/* (non-Javadoc)
	 * @see com.ovpnals.vfs.VFSStore#getMountPath(java.lang.String)
	 */
    ...
    /* (non-Javadoc)
     * @see com.ovpnals.vfs.VFSStore#getEncoding()
     */
    ...
    /* (non-Javadoc)
     * @see com.ovpnals.vfs.VFSStore#getName()
     */
    ...
    /* (non-Javadoc)
     * @see com.ovpnals.vfs.VFSStore#getGuestUsername()
     */
    ...
    /* (non-Javadoc)
     * @see com.ovpnals.vfs.VFSStore#getGuestPassword()
     */
    ...
    /* (non-Javadoc)
     * @see com.ovpnals.vfs.VFSStore#init(com.ovpnals.vfs.VFSRepository, com.ovpnals.vfs.VFSProvider)
     */
    ...
    /* (non-Javadoc)
     * @see com.ovpnals.vfs.VFSStore#getProvider()
     */
    ...
    /* (non-Javadoc)
     * @see com.ovpnals.vfs.VFSStore#getRepository()
     */
    ...
    /* (non-Javadoc)
     * @see com.ovpnals.vfs.VFSStore#getStoreResource()
     */
