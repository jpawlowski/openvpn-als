 ...
 * response for a specified {@link VFSResource}.</p> 
 *
...
public class DAVException extends RuntimeException {
     ...
     * <p>Create a new {@link DAVException} instance.</p>
     */
    public DAVException(int status, String message, VFSResource resource) {
     ...
     * <p>Create a new {@link DAVException} instance.</p>
     */
    public DAVException(int s, String m, Throwable t, VFSResource r) {
        super(m, t);
        this.resource = r;
        this.status = s;
    }
    ...
    /**
     * <p>Return the {@link VFSResource} associated with this instance.</p>
     */
