...
/**
 * A store is a child of a {@link com.ovpnals.vfs.VFSRepository}
 * and  provides the entry point for a particular type of file system
 * (e.g. Local, SMB, FTP etc). 
 * <p>
 * It returns a list of {@link com.ovpnals.vfs.VFSMount} objects
 ...
 * {@link com.ovpnals.vfs.VFSProviderManager#registerStore(Class)}.
 * 
 * @see com.ovpnals.vfs.VFSProviderManager
 */
public interface VFSStore {
     ...
     * @return mount
     * @throws DAVException on any error.
     * @throws DAVAuthenticationRequiredException if OpenVPN-ALS authentication is required for the mount
     */
