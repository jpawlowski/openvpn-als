...
public final class FeedManager implements Runnable {
	...
	public static FeedManager getInstance() {
		if (instance == null) {
			try {
				URL baseLocation = new URL(SystemProperties.get("ovpnals.rssFeeds.baseLocation", FEED_3SP_URL));
    ...
    private boolean isTestMode() {
        return Boolean.valueOf(SystemProperties.get("ovpnals.testing", "false"));
    }
