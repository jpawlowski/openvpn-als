...
package com.ovpnals.language.actions;
...
import com.ovpnals.core.ErrorConstants;
...
public class SelectLanguageAction extends DefaultAction {
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response)
        ...
        Cookie cookie = new Cookie(SystemProperties.get("ovpnals.cookie", "SSLX_SSESHID") + "_LANG", locale.toString());
