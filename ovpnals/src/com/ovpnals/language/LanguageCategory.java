 ...
 * /com/ovpnals/agent/ApplicationResources.properties maps to the category
 * with the ID of <i>com.ovpnals.agent</i>.
 * <p>
...
public class LanguageCategory {
	 ...
	 */
	public final static String NAME_KEY = "ovpnals.resourceBundle.name";
	
	/**
	 * The message key to use to retrieve the category description
	 */
	public final static String DESCRIPTION_KEY = "ovpnals.resourceBundle.description";
	
	/**
	 * The message key to use to retrieve the category location
	 */
	public final static String LOCATION_KEY = "ovpnals.resourceBundle.location";
	
    /**
     * The message key to use to retrieve the extension id
     */
    public final static String EXTENSION_ID_KEY = "ovpnals.resourceBundle.extensionId";
     ...
     * namespace format. For example, <i>com.ovpnals.agent</i>.
     * 
     * @return category ID
     */
    public String getId() {
     ...
     * an ID of com.ovpnals.agent would have been found in
     * /com/ovpnals/agent.
     * 
     * @return path
     */
     ...
     * ovpnals-enterprise-core would have been found in
     * the core extension.
     * 
     * @return extensionId
     */
