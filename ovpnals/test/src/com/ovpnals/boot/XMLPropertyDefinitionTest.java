...
public class XMLPropertyDefinitionTest {
    ...
    public void fromXMLElement() throws JDOMException {
        ...
        el.setAttribute("validation", "com.ovpnals.input.validators.IntegerValidator");
        ...
        el.setAttribute("validation", "com.ovpnals.input.validators.IntegerValidator(minValue=10,maxValue=100)");
        ...
        Assert.assertEquals("com.ovpnals.input.validators.IntegerValidator(minValue=10,maxValue=100)", def2.getValidationString());
