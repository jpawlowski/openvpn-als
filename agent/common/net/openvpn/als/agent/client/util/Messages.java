...
/**
 * Accesor class for message resources for the Common VPN Client classes.
 */
    ...
    public static String getString(String key) {
        try {
        	if(resourceBundle == null) {
        		 resourceBundle = ResourceBundle.getBundle("net.openvpn.als.agent.client.util.ApplicationResources"); //$NON-NLS-1$
        	}
