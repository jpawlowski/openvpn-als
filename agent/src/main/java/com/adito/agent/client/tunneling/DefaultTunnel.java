...
public class DefaultTunnel implements TunnelConfiguration {
     ...
     * (non-Javadoc)
     * 
     * @see com.adito.forwarding.Tunnel#getId()
     */
    public int getId() {
        return id;
    }
     ...
     * (non-Javadoc)
     * 
     * @see com.adito.forwarding.Tunnel#isPermanent()
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.adito.forwarding.Tunnel#getSourceInterface()
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.adito.forwarding.Tunnel#getDestinationPort()
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.adito.vpn.base.Tunnel#isTemporarySingleConnect()
     */
    ...
    /**
     * Set the Adito resource id of the tunnel.
     * 
	...
	/* (non-Javadoc)
	 * @see com.adito.agent.util.ListeningSocketConfiguration#getLaunchId()
	 */
