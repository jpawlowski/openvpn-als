...
public class ApplicationEventListener implements ApplicationLauncherEvents {
     ...
     * (non-Javadoc)
     * 
     * @see com.adito.vpn.util.ApplicationLauncherEvents#startingLaunch(java.lang.String)
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.adito.vpn.util.ApplicationLauncherEvents#processingDescriptor()
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.adito.vpn.util.ApplicationLauncherEvents#startDownload(long)
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.adito.vpn.util.ApplicationLauncherEvents#progressedDownload(long)
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.adito.vpn.util.ApplicationLauncherEvents#completedDownload()
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.adito.vpn.util.ApplicationLauncherEvents#executingApplication(java.lang.String,
     *      java.lang.String)
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.adito.vpn.util.ApplicationLauncherEvents#finishedLaunch()
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.adito.vpn.util.ApplicationLauncherEvents#createTunnel(java.lang.String,
     ...
     * (non-Javadoc)
     * 
     * @see com.adito.vpn.util.ApplicationLauncherEvents#debug(java.lang.String)
     */
