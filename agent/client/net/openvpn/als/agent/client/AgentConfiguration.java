...
public class AgentConfiguration {
    ...
    protected String agentType = "openvpnalsAgent";
	...
	/**
	 * Set whether the agent should attempt to get OpenVPN-ALS resources and
	 * add launcher shortcuts to the {@link AgentClientGUI} implementation.
	 * 
	 * @param getResources whether to get OpenVPN-ALS resources
	 */
	...
	/**
	 * Get whether the agent should attempt to get OpenVPN-ALS resources and
	 * add launcher shortcuts to the {@link AgentClientGUI} implementation.
	 * 
	 * @return whether to get OpenVPN-ALS resources
	 */
