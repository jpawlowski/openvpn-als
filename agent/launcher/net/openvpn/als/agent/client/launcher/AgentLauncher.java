...
public class AgentLauncher extends Applet implements ApplicationLauncherEvents {
    ...
    public void init() {
        ...
        cacheDirectory = getParameter("dir", ".openvpnals"); //$NON-NLS-1$ //$NON-NLS-
...
//            System.out.println("Loading resources from " + url);
            Messages.setBundle(Utils.getBundle(
                "net.openvpn.als.agent.client.launcher.ApplicationResources",  // $NON-NLS-1$ 
                locale, 
                cl, url));
            net.openvpn.als.agent.client.util.Messages.setBundle(Utils.getBundle(
                "net.openvpn.als.agent.client.util.ApplicationResources",  // $NON-NLS-1$ 
                locale, 
                cl, url));
            net.openvpn.als.agent.client.util.types.Messages.setBundle(Utils.getBundle(
                "net.openvpn.als.agent.client.util.types.ApplicationResources",  // $NON-NLS-1$ 
                locale, 
                cl, url));
