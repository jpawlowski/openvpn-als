...
/**
 * Accesor class for message resources for the Launcher Applet.
 */
    ...
    public static String getString(String key) {
        try {
        	if(resourceBundle == null) {
        		 resourceBundle = ResourceBundle.getBundle("net.openvpn.als.agent.client.launcher.ApplicationResources");
        	}
