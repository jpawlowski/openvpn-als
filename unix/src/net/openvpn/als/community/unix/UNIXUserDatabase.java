...
import net.openvpn.als.unixauth.BCrypt;
import net.openvpn.als.unixauth.DESCrypt;
import net.openvpn.als.unixauth.MD5Crypt;
import net.openvpn.als.unixauth.UNIXRole;
import net.openvpn.als.unixauth.UNIXUser;
...
public class UNIXUserDatabase extends DefaultUserDatabase {
    ...
    public void open(CoreServlet controllingServlet, Realm realm) throws Exception {
        ...
        open = true;
        if (SystemProperties.get("openvpnals.unix.passwordChange", "false").equals("true")) {
     ...
     * (non-Javadoc)
     * 
     * @see net.openvpn.als.security.UserDatabase#logon(java.lang.String,
     *      java.lang.String)
     */
     ...
     * (non-Javadoc)
     * 
     * @see net.openvpn.als.security.UserDatabase#checkPassword(java.lang.String,
    ...
    public void changePassword(String username, String oldPassword, String password, boolean forcePasswordChangeAtLogon)
        ...
        try {
            p = Runtime.getRuntime().exec(
                "true".equals(SystemProperties.get("openvpnals.useDevConfig", "false")) ? "sudo /usr/sbin/chpasswd"
                                : "/usr/sbin/chpasswd");
