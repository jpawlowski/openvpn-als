...
import net.openvpn.als.networkplaces.DefaultNetworkPlace;
...
import net.openvpn.als.networkplaces.forms.NetworkPlaceForm;
...
/**
 * Extension of {@link net.openvpn.als.policyframework.actions.AbstractResourceDispatchAction}
...
public class ShowNetworkPlaceAction extends AbstractResourceDispatchAction {
    ...
    /* (non-Javadoc)
     * @see net.openvpn.als.policyframework.actions.AbstractResourceDispatchAction#createResource(org.apache.struts.action.ActionMapping, org.apache.struts.action.ActionForm, javax.servlet.http.HttpServletRequest, javax.servlet.http.HttpServletResponse)
     */
