...
import net.openvpn.als.networkplaces.NetworkPlaceResourceType;
import net.openvpn.als.networkplaces.NetworkPlaceUploadHandler;
import net.openvpn.als.networkplaces.NetworkPlacesException;
import net.openvpn.als.networkplaces.clipboard.NetworkPlaceClipboardContent;
import net.openvpn.als.networkplaces.forms.FileSystemForm;
import net.openvpn.als.networkplaces.model.FileItem;
import net.openvpn.als.networkplaces.model.FileSystemItem;
import net.openvpn.als.networkplaces.model.FolderItem;
...
import net.openvpn.als.security.AbstractHTTPAuthenticationModule;
...
import net.openvpn.als.vfs.ZipDownload;
import net.openvpn.als.vfs.clipboard.Clipboard;
import net.openvpn.als.vfs.clipboard.ClipboardContent;
 ...
 * {@link net.openvpn.als.networkplaces.NetworkPlace}.
 * <p>
...
public class FileSystemViewDispatchAction extends AbstractPopupAuthenticatedDispatchAction {
	 ...
	 * net.openvpn.als.vfs.NetworkPlace>.
	 * 
	 * @param mapping The
...
//            }
	 ...
	 * {@link net.openvpn.als.networkplaces.clipboard.NetworkPlaceClipboardContent}.
	 * 
	 * @param mapping The
	 *        <code>ActionMapping<code> associated with this dispatch action.
	 * @param form The <code>FileSystemForm<code> for the action.
     ...
     * {@link net.openvpn.als.networkplaces.clipboard.NetworkPlaceClipboardContent} to the
     * specified location.
     * 
	 ...
	 * (non-Javadoc)
	 * 
	 * @see net.openvpn.als.core.actions.AuthenticatedDispatchAction#gotoLogon(org.apache.struts.action.ActionMapping,
	 *      org.apache.struts.action.ActionForm,
	 *      javax.servlet.http.HttpServletRequest,
	 *      javax.servlet.http.HttpServletResponse)
	 */
