...
import net.openvpn.als.extensions.types.PluginDatabase;

/**
 * The <i>System Configuration> {@link net.openvpn.als.extensions.types.PluginDatabase} implementation
 * is responsible for storing an retrieving OpenVPNALS's network places resources and
 * configuration.
 */
