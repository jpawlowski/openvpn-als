...
package net.openvpn.als.networkplaces.store.webdav;
...
public class WebDAVProvider extends DefaultVFSProvider implements NetworkPlaceVFSProvider {
    ...
    public WebDAVProvider() {
        super(WebDAVStore.WEBDAV_SCHEME,
            true,
            false,
