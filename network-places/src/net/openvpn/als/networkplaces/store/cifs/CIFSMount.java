 ...
 * net.openvpn.als.vfs.webdav.AbstractMount> for use with smb paths and also
...
//    /* (non-Javadoc)
//     * @see net.openvpn.als.vfs.webdav.AbstractNetworkPlaceMount#getRootVFSURI(net.openvpn.als.vfs.webdav.DAVTransaction)
//     */
     ...
     * (non-Javadoc)
     * 
     * @see net.openvpn.als.vfs.webdav.DAVMount#createRoot(java.lang.String,
