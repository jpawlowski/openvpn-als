 ...
 * <p>
 * The {@link VFSResource} instances returned by this mount use the OpenVPNALS
...
public abstract class AbstractNetworkPlaceMount implements VFSMount {
	...
	/* (non-Javadoc)
	 * @see net.openvpn.als.vfs.VFSMount#createAuthenticatedVFSFileObject(java.lang.String, net.openvpn.als.security.PasswordCredentials)
	 */
