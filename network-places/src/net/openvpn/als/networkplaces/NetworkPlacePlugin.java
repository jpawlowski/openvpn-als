...
import  net.openvpn.als.networkplaces.store.webdav.WebDAVProvider;
...
import net.openvpn.als.networkplaces.forms.FileSystemForm;
import net.openvpn.als.networkplaces.itemactions.FavoriteOpenWebFolderAction;
import net.openvpn.als.networkplaces.itemactions.OpenWebFolderAction;
import net.openvpn.als.networkplaces.store.cifs.CIFSProvider;
import net.openvpn.als.networkplaces.store.cifs.CIFSStore;
import net.openvpn.als.networkplaces.store.file.FileProvider;
import net.openvpn.als.networkplaces.store.file.FileStore;
import net.openvpn.als.networkplaces.store.ftp.FTPProvider;
import net.openvpn.als.networkplaces.store.ftp.FTPStore;
import net.openvpn.als.networkplaces.store.jar.JarProvider;
import net.openvpn.als.networkplaces.store.jar.JarStore;
import net.openvpn.als.networkplaces.store.tar.TarStore;
import net.openvpn.als.networkplaces.store.webdav.WebDAVStore;
import net.openvpn.als.networkplaces.store.zip.ZipProvider;
import net.openvpn.als.networkplaces.store.zip.ZipStore;
import net.openvpn.als.networkplaces.store.sftp.SFTPStore;
import net.openvpn.als.networkplaces.store.sftp.SFTPProvider;
...
import net.openvpn.als.vfs.utils.UploadHandlerFactory;
...
public class NetworkPlacePlugin extends DefaultPlugin {
	 ...
	 * Extension bundle ID
	 */
	public static final String BUNDLE_ID = "network-places";
	...
	public NetworkPlacePlugin() {
		super("/WEB-INF/network-places-tiles-defs.xml", true);
	}
