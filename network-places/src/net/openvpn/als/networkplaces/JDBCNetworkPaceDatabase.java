...
public class JDBCNetworkPaceDatabase implements NetworkPlaceDatabase, CoreListener {
     ...
     * (non-Javadoc)
     * 
     * @see net.openvpn.als.security.SystemDatabase#createNetworkPlace(java.lang.String,
     ...
     * (non-Javadoc)
     * 
     * @see net.openvpn.als.security.SystemDatabase#getNetworkPlace(int)
     */
    ...
    /* (non-Javadoc)
     * @see net.openvpn.als.networkplaces.NetworkPlaceDatabase#getNetworkPlace(java.lang.String, int)
     */
     ...
     * (non-Javadoc)
     * 
     * @see net.openvpn.als.security.SystemDatabase#updateNetworkPlace(int,
     *      java.lang.String, java.lang.String, java.lang.String,
     ...
     * (non-Javadoc)
     * 
     * @see net.openvpn.als.security.SystemDatabase#getNetworkPlaces()
     */
     ...
     * (non-Javadoc)
     * 
     * @see net.openvpn.als.security.SystemDatabase#deleteNetworkPlace(int)
     */
    ...
    /* (non-Javadoc)
     * @see net.openvpn.als.networkplaces.NetworkPlaceDatabase#getNetworkPlaces(int)
     */
