...
import com.ovpnals.tunnels.itemactions.SwitchOffAction;
import com.ovpnals.tunnels.itemactions.SwitchOnAction;
...
public class TunnelPlugin extends DefaultPlugin {
     ...
     * Extension bundle ID
     */
    public static final String BUNDLE_ID = "ovpnals-community-tunnels";
     ...
     */
    public TunnelPlugin() {
        super("/WEB-INF/ovpnals-community-tunnels-tiles-defs.xml", true);
    }

    /* (non-Javadoc)
     * @see com.ovpnals.extensions.types.DefaultPlugin#activatePlugin()
     */
