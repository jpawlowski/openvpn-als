...
import com.ovpnals.input.validators.HostnameOrIPAddressWithReplacementsValidator;
...
public class TunnelForm extends AbstractFavoriteResourceForm {
     ...
     * (non-Javadoc)
     * 
     * @see com.ovpnals.policyframework.forms.AbstractResourceForm#validate(org.apache.struts.action.ActionMapping,
     ...
     * (non-Javadoc)
     * 
     * @see com.ovpnals.policyframework.forms.AbstractFavoriteResourceForm#reset(org.apache.struts.action.ActionMapping,
     *      javax.servlet.http.HttpServletRequest)
     */
