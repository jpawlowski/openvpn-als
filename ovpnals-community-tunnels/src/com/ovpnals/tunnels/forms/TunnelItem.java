...
package com.ovpnals.tunnels.forms;
...
import com.ovpnals.tunnels.TransportType;
import com.ovpnals.tunnels.Tunnel;

/**
 * Implementation of an {@link com.ovpnals.navigation.AbstractFavoriteItem}
 * that wraps {@link com.ovpnals.tunnels.Tunnel} resources for display.
 */
public class TunnelItem extends AbstractFavoriteItem {
     ...
     * {@link com.ovpnals.policyframework.ResourceItem#getResource} would
     * normally be used.
     * 
     * @return tunnel
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.ovpnals.navigation.FavoriteItem#getOnClick()
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.ovpnals.navigation.FavoriteItem#getLink()
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.ovpnals.navigation.FavoriteItem#getName()
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.ovpnals.navigation.FavoriteItem#getTarget()
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.ovpnals.navigation.AbstractFavoriteItem#getFavoriteSubType()
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.ovpnals.navigation.AbstractFavoriteItem#getSmallIconPath(javax.servlet.http.HttpServletRequest)
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.ovpnals.navigation.AbstractFavoriteItem#getLargeIconPath(javax.servlet.http.HttpServletRequest)
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.ovpnals.policyframework.ResourceItem#getLargeIconAdditionalIcon(javax.servlet.http.HttpServletRequest)
     */
