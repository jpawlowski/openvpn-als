...
package com.ovpnals.tunnels.agent;
...
import com.ovpnals.tunnels.TunnelException;
...
public class DefaultRemoteTunnelManager implements RemoteTunnelManager {
     ...
     * (non-Javadoc)
     * 
     * @see com.ovpnals.agent.remote.RemoteTunnelManager#init()
     */
    public void init() {
    }

    /* (non-Javadoc)
     * @see com.ovpnals.tunnels.agent.RemoteTunnelManager#createRemoteTunnel(com.ovpnals.tunnels.Tunnel, com.ovpnals.agent.AgentTunnel, com.ovpnals.policyframework.LaunchSession)
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.ovpnals.agent.remote.RemoteTunnelManager#getRemoteTunnels()
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.ovpnals.agent.remote.RemoteTunnelManager#stopRemoteTunnel(com.ovpnals.agent.remote.RemoteTunnel)
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.ovpnals.agent.remote.RemoteTunnelManager#getRemoteTunnels(com.ovpnals.security.SessionInfo)
     */
