...
package com.ovpnals.community.unix;
...
import com.ovpnals.unixauth.BCrypt;
import com.ovpnals.unixauth.DESCrypt;
import com.ovpnals.unixauth.MD5Crypt;
import com.ovpnals.unixauth.UNIXRole;
import com.ovpnals.unixauth.UNIXUser;
...
public class UNIXUserDatabase extends DefaultUserDatabase {
    ...
    public void open(CoreServlet controllingServlet, Realm realm) throws Exception {
        ...
        open = true;
        if (SystemProperties.get("ovpnals.unix.passwordChange", "false").equals("true")) {
     ...
     * (non-Javadoc)
     * 
     * @see com.ovpnals.security.UserDatabase#checkPassword(java.lang.String,
    ...
    public void changePassword(String username, String oldPassword, String password, boolean forcePasswordChangeAtLogon)
        ...
        try {
            p = Runtime.getRuntime().exec(
                "true".equals(SystemProperties.get("ovpnals.useDevConfig", "false")) ? "sudo /usr/sbin/chpasswd"
                                : "/usr/sbin/chpasswd");
