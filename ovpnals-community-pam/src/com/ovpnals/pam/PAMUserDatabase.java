...
import com.ovpnals.core.CoreJAASConfiguration;
...
public class PAMUserDatabase extends DefaultUserDatabase
{
	...
	private final static String DEFAULT_SERVICE_NAME = "ovpnals";
	...
	/* (non-Javadoc)
	 * @see com.ovpnals.security.DefaultUserDatabase#open(com.ovpnals.core.CoreServlet, com.ovpnals.realms.Realm)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.ovpnals.security.UserDatabase#allRoles()
	 */
	@SuppressWarnings("unchecked")
	...
	/* (non-Javadoc)
	 * @see com.ovpnals.security.UserDatabase#allUsers()
	 */
	@SuppressWarnings("unchecked")
