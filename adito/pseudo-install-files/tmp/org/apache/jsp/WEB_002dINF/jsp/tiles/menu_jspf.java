...
public final class menu_jspf extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    com.adito.core.AvailableMenuItem _jspx_level1MenuItem_1 = null;
    com.adito.core.AvailableMenuItem _jspx_level2MenuItem_2 = null;
    ...
    try {
      ...
      com.adito.navigation.tags.MenuAvailableTag _jspx_th_navigation_menuAvailable_0 = (com.adito.navigation.tags.MenuAvailableTag) _jspx_tagPool_navigation_menuAvailable.get(com.adito.navigation.tags.MenuAvailableTag.class);
 ...
 AvailableMenuItem selectedMenuItem = (AvailableMenuItem)request.getAttribute(Constants.SELECTED_MENU); 
		   ...
		   if(CoreUtil.isInManagementConsole(request)) {
              ...
              out.write('	');
              //  input:frame
              com.adito.input.tags.FrameTag _jspx_th_input_frame_0 = (com.adito.input.tags.FrameTag) _jspx_tagPool_input_frame_titleKey_titleId_styleClass_panelId_bundle.get(com.adito.input.tags.FrameTag.class);
              ...
              if (_jspx_eval_input_frame_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                ...
                do {
                    ...
                    do {
                      ...
                      if (_jspx_eval_logic_notEmpty_1 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                        do {
                          ...
                          out.write("\t\t\t\t\t\t\t\t");
                          //  input:toolTip
                          com.adito.input.tags.ToolTipTag _jspx_th_input_toolTip_0 = (com.adito.input.tags.ToolTipTag) _jspx_tagPool_input_toolTip_target_styleId_key_href_bundle.get(com.adito.input.tags.ToolTipTag.class);
                      ...
                      if (_jspx_eval_logic_notEqual_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                        do {
                          ...
                          _jspx_th_logic_iterate_1.setType("com.adito.core.AvailableMenuItem");
                          int _jspx_eval_logic_iterate_1 = _jspx_th_logic_iterate_1.doStartTag();
                          if (_jspx_eval_logic_iterate_1 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                            com.adito.core.AvailableMenuItem level1MenuItem = null;
                            if (_jspx_eval_logic_iterate_1 != javax.servlet.jsp.tagext.Tag.EVAL_BODY_INCLUDE) {
                              out = _jspx_page_context.pushBody();
                              _jspx_th_logic_iterate_1.setBodyContent((javax.servlet.jsp.tagext.BodyContent) out);
                              _jspx_th_logic_iterate_1.doInitBody();
                            }
                            level1MenuItem = (com.adito.core.AvailableMenuItem) _jspx_page_context.findAttribute("level1MenuItem");
                            do {
                              out.write("\t\t\t\t\t\n");
                              out.write("\t\t\t\t\t\t\t\t");
                              //  logic:notEmpty
                              ...
                              out.write("\t\t\t\t\t\t\t\t\t\t");
                              //  input:toolTip
                              com.adito.input.tags.ToolTipTag _jspx_th_input_toolTip_1 = (com.adito.input.tags.ToolTipTag) _jspx_tagPool_input_toolTip_target_styleId_key_href_bundle.get(com.adito.input.tags.ToolTipTag.class);
                              ...
                              _jspx_th_logic_iterate_2.setType("com.adito.core.AvailableMenuItem");
                              ...
                              com.adito.core.AvailableMenuItem level2MenuItem = null;
                              ...
                              level2MenuItem = (com.adito.core.AvailableMenuItem) _jspx_page_context.findAttribute("level2MenuItem");
                              do {
                              out.write("\t\t\t\t\t\n");
                              out.write("\t\t\t\t\t\t\t\t\t\t");
                              //  logic:notEmpty
                              ...
                              out.write("\t\t\t\t\t\t\t\t\t\t\t\t");
                              //  input:toolTip
                              com.adito.input.tags.ToolTipTag _jspx_th_input_toolTip_2 = (com.adito.input.tags.ToolTipTag) _jspx_tagPool_input_toolTip_target_styleId_key_href_bundle.get(com.adito.input.tags.ToolTipTag.class);
                  ...
                  com.adito.security.tags.CheckAuthenticatedTag _jspx_th_security_checkAuthenticated_0 = (com.adito.security.tags.CheckAuthenticatedTag) _jspx_tagPool_security_checkAuthenticated_requiresAuthentication.get(com.adito.security.tags.CheckAuthenticatedTag.class);
                  ...
                  out.write("\t");
 if (Util.isNullOrTrimmedBlank(SystemProperties.get("adito.footer.copyright", ""))) { 
                  out.write('\n');
                  out.write('	');
                  out.write('	');
                  ...
                  out.write('	');
                  out.write('	');
                  out.print( SystemProperties.get("adito.footer.copyright"));
                  out.write('\n');
                  out.write('	');
 } 
                  out.write("\n");
                  out.write("    &nbsp;");
                  out.print( com.adito.boot.ContextHolder.getContext().getVersion() );
                  out.write("<br/>\n");
                  out.write("\t\n");
                  out.write("\t\t");
 if(new File("build.xml").exists()) { 
                  ...
                  out.write("\t");
 if (Util.isNullOrTrimmedBlank(SystemProperties.get("adito.footer.copyright.additional", ""))) { 
                  out.write('\n');
                  out.write('	');
                  out.write('	');
                  ...
                  out.write('	');
                  out.write('	');
                  out.print( SystemProperties.get("adito.footer.copyright.additional"));
                  out.write('\n');
                  out.write('	');
 } 
                  out.write("\n");
