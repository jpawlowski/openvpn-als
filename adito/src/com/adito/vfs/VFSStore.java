...
/**
 * A store is a child of a {@link com.adito.vfs.VFSRepository}
 * and  provides the entry point for a particular type of file system
 * (e.g. Local, SMB, FTP etc). 
 * <p>
 * It returns a list of {@link com.adito.vfs.VFSMount} objects
 ...
 * {@link com.adito.vfs.VFSProviderManager#registerStore(Class)}.
 * 
 * @see com.adito.vfs.VFSProviderManager
 */
public interface VFSStore {
     ...
     * @return mount
     * @throws DAVException on any error.
     * @throws DAVAuthenticationRequiredException if Adito authentication is required for the mount
     */
