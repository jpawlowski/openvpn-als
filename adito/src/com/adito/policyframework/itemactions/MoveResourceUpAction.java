...
/**
 */
public class MoveResourceUpAction extends AbstractPathAction {
    /**
     */
    public static final String TABLE_ITEM_ACTION_ID = "moveUp";
     ...
     */
    public MoveResourceUpAction(int navigationContext, String messageResourcesKey) {
        this(navigationContext, messageResourcesKey, "{2}.do?actionTarget=moveUp&selectedResource={0}");
    }
     ...
     * @param requiredPath
     */
    public MoveResourceUpAction(int navigationContext, String messageResourcesKey, String requiredPath) {
        super(TABLE_ITEM_ACTION_ID, messageResourcesKey, 180, false, navigationContext, requiredPath);
    }
