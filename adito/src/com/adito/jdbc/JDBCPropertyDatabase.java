...
import com.adito.properties.PropertyDatabase;
 ...
 * <code>adito.jdbcPropertyDatabase.cacheTTL</code> and
 * <code>adito.jdbcPropertyDatabase.cacheMaxObjs</code>
 */
...
public class JDBCPropertyDatabase implements PropertyDatabase {
    ...
    final static Long CACHE_TTL = new Long(SystemProperties.get("adito.jdbcPropertyDatabase.cacheTTL", "180000"));
    final static Integer CACHE_MAXOBJS = new Integer(SystemProperties.get("adito.jdbcPropertyDatabase.cacheMaxObjs", "2000"));
    ...
    public void open(CoreServlet controllingServlet) throws Exception {
        ...
        DBUpgrader upgrader = new DBUpgrader(new VersionInfo.Version(SystemProperties.get("adito.version", "0.9.1")), db, new File(CoreServlet.getServlet().getServletContext().getRealPath("/") + "/WEB_INF/" + SystemProperties.get("adito.directories.db", "db")), upgradeDir);
        // end change
        upgrader.upgrade();
     ...
     * (non-Javadoc)
     * 
     * @see com.adito.boot.PropertyDatabase#storeProperty(int,
    ...
    /* (non-Javadoc)
     * @see com.adito.properties.PropertyDatabase#getPropertyProfiles(java.lang.String, boolean, int)
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.adito.boot.PropertyDatabase#getPropertyProfile(int)
     */
    ...
    /* (non-Javadoc)
     * @see com.adito.properties.PropertyDatabase#createPropertyProfile(java.lang.String, java.lang.String, java.lang.String, int, int)
     */
    ...
    /* (non-Javadoc)
     * @see com.adito.properties.PropertyDatabase#updatePropertyProfile(int, java.lang.String, java.lang.String)
     */
    ...
    /* (non-Javadoc)
     * @see com.adito.properties.PropertyDatabase#getPropertyProfile(java.lang.String, java.lang.String, int)
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.adito.security.UserDatabase#loadAttributes(com.adito.security.User)
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.adito.properties.PropertyDatabase#createAttributeDefinition(com.adito.properties.AttributeDefinition)
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.adito.properties.PropertyDatabase#updateAttributeDefinition(com.adito.properties.AttributeDefinition)
     */
