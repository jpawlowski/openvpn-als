 ...
 * <i>hostname</i> or <i>ipAddress</i>. The string may also contain
 * replacement variables. 
 */
public class HostnameOrIPAddressWithReplacementsValidator extends StringValidator {
	
	private static final int MAX_HOST_OR_IP_CHARS = 255;
    /**
	 * Regular expression for a string in the format <i>hostname</i> or
	 * <i>ipAddress</i>. May also contain replacement variables
	 */
	 ...
	 * Constructor.
	 */
	public HostnameOrIPAddressWithReplacementsValidator() {
