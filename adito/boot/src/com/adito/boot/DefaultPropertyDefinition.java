...
/**
 * Default implementation of a {@link com.adito.boot.PropertyDefinition}.
 * <p>
 ...
 * <code>com.adito.input.validators.IntegerValidator(minValue=10,maxValue=20)</code>.
 * 
 */
public class DefaultPropertyDefinition implements PropertyDefinition, Comparable<PropertyDefinition>, Serializable {
        ...
        switch (type) {
            ...
            case TYPE_INTEGER:
                if (this.validationString == null || this.validationString.equals("")) {
                    this.validationString = "com.adito.input.validators.IntegerValidator(replacementVariables="
     ...
     * (non-Javadoc)
     * 
     * @see com.adito.boot.PropertyDefinition#getMessageResourcesKey()
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.adito.boot.PropertyDefinition#getCategory()
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.adito.boot.PropertyDefinition#getName()
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.adito.boot.PropertyDefinition#getType()
     */
    public int getType() {
        return type;
    }
     ...
     * (non-Javadoc)
     * 
     * @see com.adito.boot.PropertyDefinition#getTypeMeta()
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.adito.boot.PropertyDefinition#setTypeMeta(java.lang.String)
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.adito.boot.PropertyDefinition#getDefaultValue()
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.adito.boot.PropertyDefinition#setDefaultValue(java.lang.String)
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.adito.boot.PropertyDefinition#getSortOrder()
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.adito.boot.PropertyDefinition#getTypeMetaObject()
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.adito.boot.PropertyDefinition#isHidden()
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.adito.boot.PropertyDefinition#validate(java.lang.String,
     ...
     * (non-Javadoc)
     * 
     * @see com.adito.boot.PropertyDefinition#isRestartRequired()
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.adito.boot.PropertyDefinition#setValidationString(java.lang.String)
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.adito.boot.PropertyDefinition#getPropertyClass()
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.adito.boot.PropertyDefinition#init(com.adito.boot.PropertyClass)
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.adito.boot.PropertyDefinition#formatAttributeValue(java.lang.Object)
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.adito.boot.PropertyDefinition#getVisibility()
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.adito.boot.PropertyDefinition#parseValue(java.lang.String)
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.adito.boot.PropertyDefinition#setVisibility(int)
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.adito.boot.PropertyDefinition#getDescriptionMessageResourceKey()
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.adito.boot.PropertyDefinition#getNameMessageResourceKey()
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.adito.boot.PropertyDefinition#getCategoryLabel()
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.adito.boot.PropertyDefinition#getLabel()
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.adito.boot.PropertyDefinition#setCategoryLabel(java.lang.String)
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.adito.boot.PropertyDefinition#setLabel(java.lang.String)
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.adito.boot.PropertyDefinition#getDescription()
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.adito.boot.PropertyDefinition#setDescription(java.lang.String)
     */
