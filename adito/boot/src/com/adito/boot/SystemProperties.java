...
/**
 * Facade for retrieving system properties. If Adito has been
 * rebranded, it may be a requirement that all system properties
 * are not prefixed with <b>adito</b>. 
 * <p>
 ...
 * with <b>adito.[propertyName]</b> will be changed to use 
...
public class SystemProperties {
    ...
    public static String get(String propertyName, String defaultValue) {
        if(propertyName.startsWith("adito.") && systemPropertyPrefix != null) {
