...
public class CommandRunner extends Thread {
    ...
    public void runCommand() throws Exception {
        try {
            ...
            if (log.isDebugEnabled() || "true".equals(SystemProperties.get("adito.debugSystemCommands", "false"))) {
                ...
                if("true".equals(SystemProperties.get("adito.debugSystemCommands", "false"))) {
