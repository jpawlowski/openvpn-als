...
public class DefaultPropertyDefinitionCategory implements PropertyDefinitionCategory, Serializable {
     ...
     * (non-Javadoc)
     * 
     * @see com.adito.properties.PropertyDefinitionCategory#getParent()
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.adito.properties.PropertyDefinitionCategory#getId()
     */
    public int getId() {
        return id;
    }
     ...
     * (non-Javadoc)
     * 
     * @see com.adito.properties.PropertyDefinitionCategory#getBundle()
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.adito.properties.PropertyDefinitionCategory#getImagePath()
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.adito.properties.PropertyDefinitionCategory#addCategory(com.adito.properties.PropertyDefinitionCategory)
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.adito.properties.PropertyDefinitionCategory#removeCategory(com.adito.properties.PropertyDefinitionCategory)
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.adito.properties.PropertyDefinitionCategory#setParent(com.adito.properties.PropertyDefinitionCategory)
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.adito.properties.PropertyDefinitionCategory#size()
     */
    public int size() {
     ...
     * (non-Javadoc)
     * 
     * @see com.adito.properties.PropertyDefinitionCategory#getCategories()
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.adito.properties.PropertyDefinitionCategory#contains(com.adito.properties.PropertyDefinitionCategory)
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.adito.properties.PropertyDefinitionCategory#isEnabled()
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.adito.properties.PropertyDefinitionCategory#setEnabled(boolean)
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.adito.properties.PropertyDefinitionCategory#getPropertyClass()
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.adito.properties.PropertyDefinitionCategory#setPropertyClass(com.adito.boot.PropertyClass)
     */
	...
	/* (non-Javadoc)
	 * @see com.adito.boot.PropertyDefinitionCategory#getDefinitions()
	 */
