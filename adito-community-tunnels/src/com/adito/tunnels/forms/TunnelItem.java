...
/**
 * Implementation of an {@link com.adito.navigation.AbstractFavoriteItem}
 * that wraps {@link com.adito.tunnels.Tunnel} resources for display.
 */
public class TunnelItem extends AbstractFavoriteItem {
     ...
     * {@link com.adito.policyframework.ResourceItem#getResource} would
     * normally be used.
     * 
     * @return tunnel
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.adito.navigation.FavoriteItem#getLink()
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.adito.policyframework.ResourceItem#getLargeIconAdditionalIcon(javax.servlet.http.HttpServletRequest)
     */
