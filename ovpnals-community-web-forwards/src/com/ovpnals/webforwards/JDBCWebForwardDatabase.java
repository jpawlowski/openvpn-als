...
import com.ovpnals.replacementproxy.DefaultReplacement;
...
public class JDBCWebForwardDatabase implements WebForwardDatabase, CoreListener {
    ...
    public JDBCWebForwardDatabase() {
        int maxObjects = 1000;
        try {
            maxObjects = Integer.parseInt(SystemProperties.get("ovpnals.jdbcSystemDatabase.replacementsCache", "10000"));
        } catch (Exception e) {
        }
...
//        }
     ...
     * (non-Javadoc)
     * 
     * @see com.ovpnals.webforwards.WebForwardDatabase#getReverseProxyWebForward(com.ovpnals.security.User,
     *      java.lang.String)
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.ovpnals.webforwards.WebForwardDatabase#getWebForward(int)
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.ovpnals.webforwards.WebForwardDatabase#getWebForwards(int)
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.ovpnals.webforwards.WebForwardDatabase#getWebForwards()
     */
    ...
    /* (non-Javadoc)
     * @see com.ovpnals.webforwards.WebForwardDatabase#getWebForward(java.lang.String, int)
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.ovpnals.webforwards.WebForwardDatabase#reverseProxyPathExists(java.lang.String)
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.ovpnals.webforwards.WebForwardDatabase#createWebForward(com.ovpnals.webforwards.WebForward)
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.ovpnals.webforwards.WebForwardDatabase#updateWebForward(com.ovpnals.webforwards.WebForward)
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.ovpnals.webforwards.WebForwardDatabase#deleteWebForward(int)
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.ovpnals.security.SystemDatabase#getReplacementsForContent(java.lang.String,
     ...
     * (non-Javadoc)
     * 
     * @see com.ovpnals.security.SystemDatabase#deleteReplacement(int)
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.ovpnals.security.SystemDatabase#updateReplacement(com.ovpnals.services.Replacement)
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.ovpnals.security.SystemDatabase#createReplacement(com.ovpnals.services.Replacement)
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.ovpnals.security.SystemDatabase#getReplacements()
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.ovpnals.security.SystemDatabase#getReplacement(int)
     */
