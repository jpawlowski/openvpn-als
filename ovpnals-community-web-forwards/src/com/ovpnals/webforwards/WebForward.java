 ...
 * using OpenVPN-ALSs <strong>Web Forwarding </strong> feature.
 *
 * <p>
 ...
 *
 * <p>
 * Instances are provided by the {@link com.ovpnals.security.SystemDatabase}
...
public interface WebForward extends Resource {
     ...
     * {@link com.ovpnals.replacementproxy.actions.LaunchReplacementProxyAction}
     ...
     * a special URL always pointing to the OpenVPN-ALS server.
     * </p>
     *
     * <p>
     ...
     * {@link com.ovpnals.security.SystemDatabase#getReplacementsForContent(String, int, String, String)}.
     ...
     * by OpenVPN-ALS that are for paths at or below the specified destination
