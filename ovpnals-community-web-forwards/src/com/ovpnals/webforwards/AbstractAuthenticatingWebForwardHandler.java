...
import com.ovpnals.replacementproxy.ProxiedRequestDispatcher;
...
public abstract class AbstractAuthenticatingWebForwardHandler implements RequestHandler {
	...
	protected final static String sessionCookie = SystemProperties.get("ovpnals.cookie", "JSESSIONID");
