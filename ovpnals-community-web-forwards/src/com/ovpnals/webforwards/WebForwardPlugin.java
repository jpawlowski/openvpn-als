...
import com.ovpnals.replacementproxy.ReplacementProxyMethodHandler;
import com.ovpnals.reverseproxy.ReverseProxyMethodHandler;
...
public class WebForwardPlugin extends DefaultPlugin {
	 ...
	 * Extension bundle ID
	 */
	public static final String BUNDLE_ID = "ovpnals-community-web-forwards";
	...
	public WebForwardPlugin() {
		super("/WEB-INF/ovpnals-community-web-forwards-tiles-defs.xml", true);
	}
