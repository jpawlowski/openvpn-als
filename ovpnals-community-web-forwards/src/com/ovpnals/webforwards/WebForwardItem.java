...
import com.ovpnals.navigation.RequiresSessionPasswordAbstractFavoriteItem;

/**
 * Wrapper to make a suitable struts bean for
 * {@link com.ovpnals.webforwards.WebForward} instances.
 */
public class WebForwardItem extends RequiresSessionPasswordAbstractFavoriteItem {
    ...
    private HostService ovpnalsHost;

    /**
     * 6 Construct a new web forward item wrapping a {@link WebForward}.
     * 
     * @param webForward the web forward object
     * @param ovpnalsHost the hostname of this OpenVPN-ALS server as the
     *        client sees it.
     * @param policies list of policies
     * @param requiresPassword requires password
     */
    public WebForwardItem(WebForward webForward, HostService ovpnalsHost, List policies, boolean requiresPassword) {
        /*
     ...
     * (non-Javadoc)
     * 
     * @see com.ovpnals.navigation.AbstractFavoriteItem#getFavoriteName()
     */
