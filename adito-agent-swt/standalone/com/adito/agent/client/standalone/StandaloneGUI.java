...
package com.adito.agent.client.standalone;
...
import com.adito.agent.client.gui.swt.SWTAuthenticationDialog;
import com.adito.agent.client.gui.swt.SWTRunner;
import com.adito.agent.client.gui.swt.SWTSystemTrayGUI;
...
public class StandaloneGUI extends SWTSystemTrayGUI {
	...
	/* (non-Javadoc)
	 * @see com.adito.agent.client.gui.swt.SWTSystemTrayGUI#doInit()
	 */
	...
	/* (non-Javadoc)
	 * @see com.adito.agent.client.gui.swt.SWTSystemTrayGUI#exit()
	 */
	protected void exit() {
		super.exit();
