...
public abstract class AbstractResource implements Resource, Serializable {
     ...
     * (non-Javadoc)
     * 
     * @see com.adito.boot.policyframework.Resource#getResourceId()
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.adito.boot.policyframework.Resource#getResourceType()
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.adito.boot.policyframework.Resource#getResourceName()
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.adito.boot.policyframework.Resource#getResourceDisplayName()
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.adito.boot.policyframework.Resource#getResourceDescription()
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.adito.boot.policyframework.Resource#setResourceName(java.lang.String)
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.adito.boot.policyframework.Resource#setResourceDescription(java.lang.String)
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.adito.boot.policyframework.Resource#getDateCreated()
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.adito.boot.policyframework.Resource#getDateAmended()
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.adito.boot.policyframework.Resource#setDateAmended(java.util.Calendar)
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.adito.policyframework.Resource#paramsRequirePassword()
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.adito.policyframework.Resource#getRealmID()
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.adito.policyframework.ResourceType#getLaunchRequirement()
     */
