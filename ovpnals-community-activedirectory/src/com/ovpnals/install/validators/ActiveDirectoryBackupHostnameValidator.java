...
import com.ovpnals.input.validators.ErrorConstants;

/**
 */
public class ActiveDirectoryBackupHostnameValidator implements PropertyValidator {

    /* (non-Javadoc)
     * @see com.ovpnals.boot.PropertyValidator#validate(com.ovpnals.boot.PropertyDefinition, java.lang.String, java.util.Properties)
     */
