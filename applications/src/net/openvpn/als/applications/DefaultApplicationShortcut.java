...
/**
 * Default implementation of an {@link net.openvpn.als.applications.ApplicationShortcut}
 */
public class DefaultApplicationShortcut extends AbstractResource implements ApplicationShortcut {
    ...
    /* (non-Javadoc)
     * @see net.openvpn.als.extensions.ApplicationShortcut#getParameters()
     */
    ...
    /* (non-Javadoc)
     * @see net.openvpn.als.extensions.ApplicationShortcut#getApplication()
     */
