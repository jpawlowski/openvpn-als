...
/**
 * Wrapper for {@link net.openvpn.als.applications.ApplicationShortcut} instances.
 */
...
public class ApplicationShortcutItem extends RequiresSessionPasswordAbstractFavoriteItem {
     ...
     * (non-Javadoc)
     * 
     * @see net.openvpn.als.navigation.FavoriteItem#getLink(java.lang.String)
     */
	...
	/* (non-Javadoc)
	 * @see net.openvpn.als.navigation.AbstractFavoriteItem#getOnClick(int, javax.servlet.http.HttpServletRequest)
	 */
