...
package net.openvpn.als.applicationshortctus;
...
import net.openvpn.als.applications.ApplicationShortcutDatabase;
...
import net.openvpn.als.applications.DefaultApplicationShortcut;
import net.openvpn.als.policyframework.ResourceType;
import net.openvpn.als.testcontainer.policyframework.AbstractTestPolicyEnabledResource;
