...
/**
 * Application type to use for the <i>OpenVPN-ALS Agent</i>.
 */
public class DefaultAgentApplicationType extends JavaApplicationType {
    /*
     * (non-Javadoc)
     * @see com.ovpnals.vpn.util.types.JavaApplicationType#prepare(com.ovpnals.vpn.util.ApplicationLauncher,
     *      com.ovpnals.vpn.util.ApplicationLauncherEvents,
