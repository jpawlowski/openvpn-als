...
import com.ovpnals.agent.client.PortMonitor;
import com.ovpnals.agent.client.util.TunnelConfiguration;

/**
 * This class manages tunnels for the OpenVPN-ALS agent. Using the multiplexed
...
public class TunnelManager extends AbstractResourceManager implements RequestHandler, LocalTunnelServerListener {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.ovpnals.agent.client.AbstractResourceManager#launchResource(int)
	 */
...
//			} else {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.ovpnals.agent.client.tunneling.LocalForwardingServerListener#activeTunnelDataTransferred(com.ovpnals.agent.client.tunneling.LocalForwardingServer,
	 *      com.ovpnals.agent.client.tunneling.ActiveTunnel, byte[], int,
	 *      boolean)
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.ovpnals.agent.client.tunneling.LocalForwardingServerListener#activeTunnelStarted(com.ovpnals.agent.client.tunneling.LocalForwardingServer,
	 *      com.ovpnals.agent.client.tunneling.ActiveTunnel)
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.ovpnals.agent.client.tunneling.LocalForwardingServerListener#activeTunnelStopped(com.ovpnals.agent.client.tunneling.LocalForwardingServer,
	 *      com.ovpnals.agent.client.tunneling.ActiveTunnel)
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.ovpnals.agent.client.tunneling.LocalForwardingServerListener#localForwardingDataTransferred(com.ovpnals.agent.client.tunneling.LocalForwardingServer,
	 *      byte[], int, boolean)
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.ovpnals.agent.client.tunneling.LocalForwardingServerListener#localForwardingServerStarted(com.ovpnals.agent.client.tunneling.LocalForwardingServer)
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.ovpnals.agent.client.tunneling.LocalForwardingServerListener#localForwardingStopped(com.ovpnals.agent.client.tunneling.LocalForwardingServer)
	 */
	...
	boolean startLocalTunnel(byte[] configurationData) {
		...
		try {
			 ...
			 * connection to the OpenVPN-ALS server.
			 */
