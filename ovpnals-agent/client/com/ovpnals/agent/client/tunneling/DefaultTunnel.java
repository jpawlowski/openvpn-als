...
public class DefaultTunnel implements TunnelConfiguration {
     ...
     * (non-Javadoc)
     * 
     * @see com.ovpnals.forwarding.Tunnel#getId()
     */
    public int getId() {
        return id;
    }
     ...
     * (non-Javadoc)
     * 
     * @see com.ovpnals.forwarding.Tunnel#getType()
     */
    public int getType() {
        return type;
    }
     ...
     * (non-Javadoc)
     * 
     * @see com.ovpnals.forwarding.Tunnel#isPermanent()
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.ovpnals.forwarding.Tunnel#getTransport()
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.ovpnals.forwarding.Tunnel#getSourcePort()
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.ovpnals.forwarding.Tunnel#getSourceInterface()
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.ovpnals.forwarding.Tunnel#getDestinationPort()
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.ovpnals.forwarding.Tunnel#getDestinationHost()
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.ovpnals.vpn.base.Tunnel#isTemporarySingleConnect()
     */
    ...
    /**
     * Set the OpenVPN-ALS resource id of the tunnel.
     * 
	...
	/* (non-Javadoc)
	 * @see com.ovpnals.agent.util.ListeningSocketConfiguration#getLaunchId()
	 */
