...
package com.ovpnals.agent.client.applications;

import java.io.IOException;
import java.text.MessageFormat;

import com.ovpnals.agent.client.Agent;
import com.ovpnals.agent.client.Messages;
...
public class ApplicationEventListener implements ApplicationLauncherEvents {
     ...
     * (non-Javadoc)
     * 
     * @see com.ovpnals.vpn.util.ApplicationLauncherEvents#startingLaunch(java.lang.String)
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.ovpnals.vpn.util.ApplicationLauncherEvents#processingDescriptor()
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.ovpnals.vpn.util.ApplicationLauncherEvents#startDownload(long)
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.ovpnals.vpn.util.ApplicationLauncherEvents#progressedDownload(long)
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.ovpnals.vpn.util.ApplicationLauncherEvents#completedDownload()
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.ovpnals.vpn.util.ApplicationLauncherEvents#executingApplication(java.lang.String,
     *      java.lang.String)
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.ovpnals.vpn.util.ApplicationLauncherEvents#finishedLaunch()
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.ovpnals.vpn.util.ApplicationLauncherEvents#createTunnel(java.lang.String,
     ...
     * (non-Javadoc)
     * 
     * @see com.ovpnals.vpn.util.ApplicationLauncherEvents#debug(java.lang.String)
     */
