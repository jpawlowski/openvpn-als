...
import com.ovpnals.agent.client.WinRegistry;
...
import com.ovpnals.agent.client.util.Messages;
import com.ovpnals.agent.client.util.TunnelConfiguration;
import com.ovpnals.agent.client.util.XMLElement;

/**
 * Extension of {@link AbstractApplicationLauncher} for use with the OpenVPN-ALS Agent.
 */
public class AgentApplicationLauncher extends AbstractApplicationLauncher {
    ...
    /* (non-Javadoc)
     * @see com.ovpnals.agent.client.util.AbstractApplicationLauncher#replaceTokens(java.lang.String)
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.ovpnals.vpn.util.ApplicationLauncher#processLauncherElement(com.ovpnals.vpn.util.XMLElement)
     */
    ...
    /* (non-Javadoc)
     * @see com.ovpnals.vpn.util.ApplicationLauncher#getApplicationDescriptor()
     */
