...
public class JDBCApplicationShortcutDatabase implements ApplicationShortcutDatabase, CoreListener {
     ...
     * (non-Javadoc)
     * 
     * @see com.ovpnals.extensions.ApplicationShortcutDatabase#createApplicationShortcut(java.lang.String,
     ...
     * (non-Javadoc)
     * 
     * @see com.ovpnals.extensions.ApplicationShortcutDatabase#updateApplicationShortcut(int,
     *      java.lang.String, java.lang.String, java.util.Map)
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.ovpnals.extensions.ApplicationShortcutDatabase#removeApplicationShortcuts(java.lang.String)
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.ovpnals.extensions.ApplicationShortcutDatabase#getShortcuts()
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.ovpnals.extensions.ApplicationShortcutDatabase#getShortcut(int)
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.ovpnals.extensions.ApplicationShortcutDatabase#deleteShortcut(int)
     */
    ...
    /* (non-Javadoc)
     * @see com.ovpnals.applications.ApplicationShortcutDatabase#getShortcuts(int)
     */
    ...
    /* (non-Javadoc)
     * @see com.ovpnals.applications.ApplicationShortcutDatabase#getShortcut(java.lang.String, int)
     */
