...
import com.ovpnals.agent.AgentService;
import com.ovpnals.agent.AgentTunnel;
import com.ovpnals.agent.channels.ApplicationFileChannel;
...
public class ApplicationService extends AbstractResourceService implements RequestHandler {
	...
	/* (non-Javadoc)
	 * @see com.ovpnals.agent.AgentService#performStartup(com.ovpnals.agent.AgentTunnel)
	 */
	...
	/* (non-Javadoc)
	 * @see com.ovpnals.agent.AgentService#createChannel(com.maverick.multiplex.MultiplexedConnection, java.lang.String)
	 */
	...
	/* (non-Javadoc)
	 * @see com.ovpnals.agent.AgentService#initializeTunnel(com.ovpnals.agent.AgentTunnel)
	 */
