...
/**
 * Default implementation of an {@link com.ovpnals.applications.ApplicationShortcut}
 */
public class DefaultApplicationShortcut extends AbstractResource implements ApplicationShortcut {
    ...
    /* (non-Javadoc)
     * @see com.ovpnals.extensions.ApplicationShortcut#getParameters()
     */
    ...
    /* (non-Javadoc)
     * @see com.ovpnals.extensions.ApplicationShortcut#getApplication()
     */
